...
`skolem-functions.pl` demonstrates deterministic generated resources such as `skolem:observation(Patient, Test)` in rule heads. `bayes-therapy.pl` combines list-valued evidence, disease, and therapy vectors with decimal Bayes/utility calculations.
