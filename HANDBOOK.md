...
- `examples/lldm.pl` adapts Eyeling's Leg Length Discrepancy Measurement example. It translates RDF/N3 measurement data and math built-ins into `triple/3` facts plus Eyelog arithmetic rules, deriving projected points, distances, the final discrepancy, and the alarm classification.
