...
- `examples/illegitimate-reasoning.pl` detects common invalid argument patterns such as affirming the consequent, denying the antecedent, hasty generalization, and false dilemma. It keeps argument descriptions in helper predicates and emits concise `triple/3` reports with the fallacy, conclusion, and reason.
