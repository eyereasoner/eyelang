...
why(
  safeInWorld(city_errand, w1),
  proof(
    goal(safeInWorld(city_errand, w1)), by(rule("ev-range-worlds.pl", clause(27))),
    bindings([binding("T", city_errand), binding("W", w1)]),
    uses([
      proof(
        goal(safe_in_world(city_errand, w1)), by(rule("ev-range-worlds.pl", clause(25))),
        ...
        uses([
          proof(goal(trip_data(city_errand, 40, 45, 20, 100, 30, 0.18)), by(fact("ev-range-worlds.pl", clause(9)))),
          proof(
            goal(required_energy(city_errand, w1, 7.1999999999999993)), by(rule("ev-range-worlds.pl", clause(21))),
            bindings([binding("T", city_errand), binding("E", 7.1999999999999993)]),
            uses([
              proof(
                goal(base_energy(city_errand, 7.1999999999999993)), by(rule("ev-range-worlds.pl", clause(20))),
                ...
                uses([
                  proof(goal(trip_data(city_errand, 40, 45, 20, 100, 30, 0.18)), by(fact("ev-range-worlds.pl", clause(9)))),
                  proof(goal(mul(40, 0.18, 7.1999999999999993)), by(builtin(mul, 3)))
                ])
              )
            ])
          ),
          proof(goal(le(7.1999999999999993, 30)), by(builtin(le, 2)))
        ])
      )
    ])
  )
...
why(
  safeInWorld(city_errand, w2),
  proof(
    goal(safeInWorld(city_errand, w2)), by(rule("ev-range-worlds.pl", clause(27))),
    bindings([binding("T", city_errand), binding("W", w2)]),
    uses([
      proof(
        goal(safe_in_world(city_errand, w2)), by(rule("ev-range-worlds.pl", clause(25))),
        ...
        uses([
          proof(goal(trip_data(city_errand, 40, 45, 20, 100, 30, 0.18)), by(fact("ev-range-worlds.pl", clause(9)))),
          proof(
            goal(required_energy(city_errand, w2, 7.1999999999999993)), by(rule("ev-range-worlds.pl", clause(22))),
            ...
            uses([
              ...
              proof(
                goal(speed_factor(city_errand, 1.00)), by(rule("ev-range-worlds.pl", clause(14))),
                ...
                uses([
                  proof(goal(trip_data(city_errand, 40, 45, 20, 100, 30, 0.18)), by(fact("ev-range-worlds.pl", clause(9)))),
                  proof(goal(le(45, 100)), by(builtin(le, 2)))
                ])
              ),
              proof(goal(mul(7.1999999999999993, 1.00, 7.1999999999999993)), by(builtin(mul, 3)))
            ])
          ),
          proof(goal(le(7.1999999999999993, 30)), by(builtin(le, 2)))
        ])
...
why(
  safeInWorld(city_errand, w0),
  proof(
    goal(safeInWorld(city_errand, w0)), by(rule("ev-range-worlds.pl", clause(27))),
    bindings([binding("T", city_errand), binding("W", w0)]),
    uses([
      proof(
        goal(safe_in_world(city_errand, w0)), by(rule("ev-range-worlds.pl", clause(25))),
        ...
        uses([
          proof(goal(trip_data(city_errand, 40, 45, 20, 100, 30, 0.18)), by(fact("ev-range-worlds.pl", clause(9)))),
          proof(
            goal(required_energy(city_errand, w0, 7.1999999999999993)), by(rule("ev-range-worlds.pl", clause(23))),
            ...
            uses([
              ...
              proof(
                goal(temperature_factor(city_errand, 1.00)), by(rule("ev-range-worlds.pl", clause(16))),
                ...
                uses([
                  proof(goal(trip_data(city_errand, 40, 45, 20, 100, 30, 0.18)), by(fact("ev-range-worlds.pl", clause(9)))),
                  proof(goal(ge(20, 0)), by(builtin(ge, 2)))
                ])
              ),
              proof(
                goal(payload_factor(city_errand, 1.00)), by(rule("ev-range-worlds.pl", clause(19))),
                ...
                uses([
                  proof(goal(trip_data(city_errand, 40, 45, 20, 100, 30, 0.18)), by(fact("ev-range-worlds.pl", clause(9)))),
                  proof(goal(le(100, 250)), by(builtin(le, 2)))
                ])
              ),
              proof(goal(mul(7.1999999999999993, 1.00, 7.1999999999999993)), by(builtin(mul, 3))),
              proof(goal(mul(7.1999999999999993, 1.00, 7.1999999999999993)), by(builtin(mul, 3))),
...
why(
  safeInWorld(city_errand, w3),
  proof(
    goal(safeInWorld(city_errand, w3)), by(rule("ev-range-worlds.pl", clause(27))),
    bindings([binding("T", city_errand), binding("W", w3)]),
    uses([
      proof(
        goal(safe_in_world(city_errand, w3)), by(rule("ev-range-worlds.pl", clause(25))),
        ...
        uses([
          proof(goal(trip_data(city_errand, 40, 45, 20, 100, 30, 0.18)), by(fact("ev-range-worlds.pl", clause(9)))),
          proof(
            goal(required_energy(city_errand, w3, 9.3599999999999994)), by(rule("ev-range-worlds.pl", clause(24))),
            ...
            uses([
              ...
              proof(goal(mul(7.1999999999999993, 1.30, 9.3599999999999994)), by(builtin(mul, 3)))
            ])
          ),
          proof(goal(le(9.3599999999999994, 30)), by(builtin(le, 2)))
        ])
      )
    ])
  )
...
why(
  safeInWorld(winter_highway, w1),
  proof(
    goal(safeInWorld(winter_highway, w1)), by(rule("ev-range-worlds.pl", clause(27))),
    bindings([binding("T", winter_highway), binding("W", w1)]),
    uses([
      proof(
        goal(safe_in_world(winter_highway, w1)), by(rule("ev-range-worlds.pl", clause(25))),
        ...
        uses([
          proof(goal(trip_data(winter_highway, 260, 115, -5, 400, 60, 0.20)), by(fact("ev-range-worlds.pl", clause(10)))),
          proof(
            goal(required_energy(winter_highway, w1, 52.0)), by(rule("ev-range-worlds.pl", clause(21))),
            bindings([binding("T", winter_highway), binding("E", 52.0)]),
            uses([
              proof(
                goal(base_energy(winter_highway, 52.0)), by(rule("ev-range-worlds.pl", clause(20))),
                ...
                uses([
                  proof(goal(trip_data(winter_highway, 260, 115, -5, 400, 60, 0.20)), by(fact("ev-range-worlds.pl", clause(10)))),
                  proof(goal(mul(260, 0.20, 52.0)), by(builtin(mul, 3)))
                ])
              )
            ])
          ),
          proof(goal(le(52.0, 60)), by(builtin(le, 2)))
        ])
      )
    ])
  )
...
why(
  safeInWorld(heavy_delivery, w1),
  proof(
    goal(safeInWorld(heavy_delivery, w1)), by(rule("ev-range-worlds.pl", clause(27))),
    bindings([binding("T", heavy_delivery), binding("W", w1)]),
    uses([
      proof(
        goal(safe_in_world(heavy_delivery, w1)), by(rule("ev-range-worlds.pl", clause(25))),
        ...
        uses([
          proof(goal(trip_data(heavy_delivery, 180, 80, 15, 700, 55, 0.22)), by(fact("ev-range-worlds.pl", clause(11)))),
          proof(
            goal(required_energy(heavy_delivery, w1, 39.600000000000001)), by(rule("ev-range-worlds.pl", clause(21))),
            bindings([binding("T", heavy_delivery), binding("E", 39.600000000000001)]),
            uses([
              proof(
                goal(base_energy(heavy_delivery, 39.600000000000001)), by(rule("ev-range-worlds.pl", clause(20))),
                ...
                uses([
                  proof(goal(trip_data(heavy_delivery, 180, 80, 15, 700, 55, 0.22)), by(fact("ev-range-worlds.pl", clause(11)))),
                  proof(goal(mul(180, 0.22, 39.600000000000001)), by(builtin(mul, 3)))
                ])
              )
            ])
          ),
          proof(goal(le(39.600000000000001, 55)), by(builtin(le, 2)))
        ])
      )
    ])
  )
...
why(
  safeInWorld(heavy_delivery, w2),
  proof(
    goal(safeInWorld(heavy_delivery, w2)), by(rule("ev-range-worlds.pl", clause(27))),
    bindings([binding("T", heavy_delivery), binding("W", w2)]),
    uses([
      proof(
        goal(safe_in_world(heavy_delivery, w2)), by(rule("ev-range-worlds.pl", clause(25))),
        ...
        uses([
          proof(goal(trip_data(heavy_delivery, 180, 80, 15, 700, 55, 0.22)), by(fact("ev-range-worlds.pl", clause(11)))),
          proof(
            goal(required_energy(heavy_delivery, w2, 39.600000000000001)), by(rule("ev-range-worlds.pl", clause(22))),
            ...
            uses([
              ...
              proof(
                goal(speed_factor(heavy_delivery, 1.00)), by(rule("ev-range-worlds.pl", clause(14))),
                ...
                uses([
                  proof(goal(trip_data(heavy_delivery, 180, 80, 15, 700, 55, 0.22)), by(fact("ev-range-worlds.pl", clause(11)))),
                  proof(goal(le(80, 100)), by(builtin(le, 2)))
                ])
              ),
              proof(goal(mul(39.600000000000001, 1.00, 39.600000000000001)), by(builtin(mul, 3)))
            ])
          ),
          proof(goal(le(39.600000000000001, 55)), by(builtin(le, 2)))
        ])
...
why(
  safeInWorld(heavy_delivery, w0),
  proof(
    goal(safeInWorld(heavy_delivery, w0)), by(rule("ev-range-worlds.pl", clause(27))),
    bindings([binding("T", heavy_delivery), binding("W", w0)]),
    uses([
      proof(
        goal(safe_in_world(heavy_delivery, w0)), by(rule("ev-range-worlds.pl", clause(25))),
        ...
        uses([
          proof(goal(trip_data(heavy_delivery, 180, 80, 15, 700, 55, 0.22)), by(fact("ev-range-worlds.pl", clause(11)))),
          proof(
            goal(required_energy(heavy_delivery, w0, 45.539999999999999)), by(rule("ev-range-worlds.pl", clause(23))),
            ...
            uses([
              ...
              proof(
                goal(temperature_factor(heavy_delivery, 1.00)), by(rule("ev-range-worlds.pl", clause(16))),
                ...
                uses([
                  proof(goal(trip_data(heavy_delivery, 180, 80, 15, 700, 55, 0.22)), by(fact("ev-range-worlds.pl", clause(11)))),
                  proof(goal(ge(15, 0)), by(builtin(ge, 2)))
                ])
              ),
              proof(
                goal(payload_factor(heavy_delivery, 1.15)), by(rule("ev-range-worlds.pl", clause(17))),
                ...
                uses([
                  proof(goal(trip_data(heavy_delivery, 180, 80, 15, 700, 55, 0.22)), by(fact("ev-range-worlds.pl", clause(11)))),
                  proof(goal(gt(700, 500)), by(builtin(gt, 2)))
                ])
              ),
              proof(goal(mul(39.600000000000001, 1.00, 39.600000000000001)), by(builtin(mul, 3))),
              proof(goal(mul(39.600000000000001, 1.00, 39.600000000000001)), by(builtin(mul, 3))),
              proof(goal(mul(39.600000000000001, 1.15, 45.539999999999999)), by(builtin(mul, 3)))
            ])
          ),
          proof(goal(le(45.539999999999999, 55)), by(builtin(le, 2)))
        ])
      )
    ])
  )
...
why(
  safeInWorld(cold_commute, w1),
  proof(
    goal(safeInWorld(cold_commute, w1)), by(rule("ev-range-worlds.pl", clause(27))),
    bindings([binding("T", cold_commute), binding("W", w1)]),
    uses([
      proof(
        goal(safe_in_world(cold_commute, w1)), by(rule("ev-range-worlds.pl", clause(25))),
        ...
        uses([
          proof(goal(trip_data(cold_commute, 120, 90, -8, 100, 35, 0.19)), by(fact("ev-range-worlds.pl", clause(12)))),
          proof(
            goal(required_energy(cold_commute, w1, 22.800000000000001)), by(rule("ev-range-worlds.pl", clause(21))),
            bindings([binding("T", cold_commute), binding("E", 22.800000000000001)]),
            uses([
              proof(
                goal(base_energy(cold_commute, 22.800000000000001)), by(rule("ev-range-worlds.pl", clause(20))),
                ...
                uses([
                  proof(goal(trip_data(cold_commute, 120, 90, -8, 100, 35, 0.19)), by(fact("ev-range-worlds.pl", clause(12)))),
                  proof(goal(mul(120, 0.19, 22.800000000000001)), by(builtin(mul, 3)))
                ])
              )
            ])
          ),
          proof(goal(le(22.800000000000001, 35)), by(builtin(le, 2)))
        ])
      )
    ])
  )
...
why(
  safeInWorld(cold_commute, w2),
  proof(
    goal(safeInWorld(cold_commute, w2)), by(rule("ev-range-worlds.pl", clause(27))),
    bindings([binding("T", cold_commute), binding("W", w2)]),
    uses([
      proof(
        goal(safe_in_world(cold_commute, w2)), by(rule("ev-range-worlds.pl", clause(25))),
        ...
        uses([
          proof(goal(trip_data(cold_commute, 120, 90, -8, 100, 35, 0.19)), by(fact("ev-range-worlds.pl", clause(12)))),
          proof(
            goal(required_energy(cold_commute, w2, 22.800000000000001)), by(rule("ev-range-worlds.pl", clause(22))),
            ...
            uses([
              ...
              proof(
                goal(speed_factor(cold_commute, 1.00)), by(rule("ev-range-worlds.pl", clause(14))),
                ...
                uses([
                  proof(goal(trip_data(cold_commute, 120, 90, -8, 100, 35, 0.19)), by(fact("ev-range-worlds.pl", clause(12)))),
                  proof(goal(le(90, 100)), by(builtin(le, 2)))
                ])
              ),
              proof(goal(mul(22.800000000000001, 1.00, 22.800000000000001)), by(builtin(mul, 3)))
            ])
          ),
          proof(goal(le(22.800000000000001, 35)), by(builtin(le, 2)))
        ])
...
why(
  safeInWorld(cold_commute, w0),
  proof(
    goal(safeInWorld(cold_commute, w0)), by(rule("ev-range-worlds.pl", clause(27))),
    bindings([binding("T", cold_commute), binding("W", w0)]),
    uses([
      proof(
        goal(safe_in_world(cold_commute, w0)), by(rule("ev-range-worlds.pl", clause(25))),
        ...
        uses([
          proof(goal(trip_data(cold_commute, 120, 90, -8, 100, 35, 0.19)), by(fact("ev-range-worlds.pl", clause(12)))),
          proof(
            goal(required_energy(cold_commute, w0, 26.219999999999999)), by(rule("ev-range-worlds.pl", clause(23))),
            ...
            uses([
              ...
              proof(
                goal(temperature_factor(cold_commute, 1.15)), by(rule("ev-range-worlds.pl", clause(15))),
                ...
                uses([
                  proof(goal(trip_data(cold_commute, 120, 90, -8, 100, 35, 0.19)), by(fact("ev-range-worlds.pl", clause(12)))),
                  proof(goal(lt(-8, 0)), by(builtin(lt, 2)))
                ])
              ),
              proof(
                goal(payload_factor(cold_commute, 1.00)), by(rule("ev-range-worlds.pl", clause(19))),
              ...
              proof(goal(mul(22.800000000000001, 1.00, 22.800000000000001)), by(builtin(mul, 3))),
              proof(goal(mul(22.800000000000001, 1.15, 26.219999999999999)), by(builtin(mul, 3))),
              proof(goal(mul(26.219999999999999, 1.00, 26.219999999999999)), by(builtin(mul, 3)))
            ])
          ),
          proof(goal(le(26.219999999999999, 35)), by(builtin(le, 2)))
        ])
      )
    ])
  )
...
why(
  safeInWorld(cold_commute, w3),
  proof(
    goal(safeInWorld(cold_commute, w3)), by(rule("ev-range-worlds.pl", clause(27))),
    bindings([binding("T", cold_commute), binding("W", w3)]),
    uses([
      proof(
        goal(safe_in_world(cold_commute, w3)), by(rule("ev-range-worlds.pl", clause(25))),
        ...
        uses([
          proof(goal(trip_data(cold_commute, 120, 90, -8, 100, 35, 0.19)), by(fact("ev-range-worlds.pl", clause(12)))),
          proof(
            goal(required_energy(cold_commute, w3, 34.085999999999999)), by(rule("ev-range-worlds.pl", clause(24))),
            ...
            uses([
              ...
              proof(goal(mul(26.219999999999999, 1.30, 34.085999999999999)), by(builtin(mul, 3)))
            ])
          ),
          proof(goal(le(34.085999999999999, 35)), by(builtin(le, 2)))
        ])
      )
    ])
  )
...
why(
  riskyInWorld(winter_highway, w2),
  proof(
    goal(riskyInWorld(winter_highway, w2)), by(rule("ev-range-worlds.pl", clause(28))),
    bindings([binding("T", winter_highway), binding("W", w2)]),
    uses([
      proof(
        goal(risky_in_world(winter_highway, w2)), by(rule("ev-range-worlds.pl", clause(26))),
        ...
        uses([
          proof(goal(trip_data(winter_highway, 260, 115, -5, 400, 60, 0.20)), by(fact("ev-range-worlds.pl", clause(10)))),
          proof(
            goal(required_energy(winter_highway, w2, 62.399999999999999)), by(rule("ev-range-worlds.pl", clause(22))),
            ...
            uses([
              ...
              proof(
                goal(speed_factor(winter_highway, 1.20)), by(rule("ev-range-worlds.pl", clause(13))),
                ...
                uses([
                  proof(goal(trip_data(winter_highway, 260, 115, -5, 400, 60, 0.20)), by(fact("ev-range-worlds.pl", clause(10)))),
                  proof(goal(gt(115, 100)), by(builtin(gt, 2)))
                ])
              ),
              proof(goal(mul(52.0, 1.20, 62.399999999999999)), by(builtin(mul, 3)))
            ])
          ),
          proof(goal(gt(62.399999999999999, 60)), by(builtin(gt, 2)))
        ])
      )
    ])
  )
...
why(
  riskyInWorld(winter_highway, w0),
  proof(
    goal(riskyInWorld(winter_highway, w0)), by(rule("ev-range-worlds.pl", clause(28))),
    bindings([binding("T", winter_highway), binding("W", w0)]),
    uses([
      proof(
        goal(risky_in_world(winter_highway, w0)), by(rule("ev-range-worlds.pl", clause(26))),
        ...
        uses([
          proof(goal(trip_data(winter_highway, 260, 115, -5, 400, 60, 0.20)), by(fact("ev-range-worlds.pl", clause(10)))),
          proof(
            goal(required_energy(winter_highway, w0, 77.500799999999998)), by(rule("ev-range-worlds.pl", clause(23))),
            ...
            uses([
              ...
              proof(
                goal(temperature_factor(winter_highway, 1.15)), by(rule("ev-range-worlds.pl", clause(15))),
                ...
                uses([
                  proof(goal(trip_data(winter_highway, 260, 115, -5, 400, 60, 0.20)), by(fact("ev-range-worlds.pl", clause(10)))),
                  proof(goal(lt(-5, 0)), by(builtin(lt, 2)))
                ])
              ),
              proof(
                goal(payload_factor(winter_highway, 1.08)), by(rule("ev-range-worlds.pl", clause(18))),
                ...
                uses([
                  proof(goal(trip_data(winter_highway, 260, 115, -5, 400, 60, 0.20)), by(fact("ev-range-worlds.pl", clause(10)))),
                  proof(goal(gt(400, 250)), by(builtin(gt, 2))),
                  proof(goal(le(400, 500)), by(builtin(le, 2)))
                ])
              ),
              proof(goal(mul(52.0, 1.20, 62.399999999999999)), by(builtin(mul, 3))),
              proof(goal(mul(62.399999999999999, 1.15, 71.759999999999991)), by(builtin(mul, 3))),
              proof(goal(mul(71.759999999999991, 1.08, 77.500799999999998)), by(builtin(mul, 3)))
            ])
          ),
          proof(goal(gt(77.500799999999998, 60)), by(builtin(gt, 2)))
        ])
      )
    ])
  )
...
why(
  riskyInWorld(winter_highway, w3),
  proof(
    goal(riskyInWorld(winter_highway, w3)), by(rule("ev-range-worlds.pl", clause(28))),
    bindings([binding("T", winter_highway), binding("W", w3)]),
    uses([
      proof(
        goal(risky_in_world(winter_highway, w3)), by(rule("ev-range-worlds.pl", clause(26))),
        ...
        uses([
          proof(goal(trip_data(winter_highway, 260, 115, -5, 400, 60, 0.20)), by(fact("ev-range-worlds.pl", clause(10)))),
          proof(
            goal(required_energy(winter_highway, w3, 100.75104)), by(rule("ev-range-worlds.pl", clause(24))),
            ...
            uses([
              ...
              proof(goal(mul(77.500799999999998, 1.30, 100.75104)), by(builtin(mul, 3)))
            ])
          ),
          proof(goal(gt(100.75104, 60)), by(builtin(gt, 2)))
        ])
      )
    ])
  )
...
why(
  riskyInWorld(heavy_delivery, w3),
  proof(
    goal(riskyInWorld(heavy_delivery, w3)), by(rule("ev-range-worlds.pl", clause(28))),
    bindings([binding("T", heavy_delivery), binding("W", w3)]),
    uses([
      proof(
        goal(risky_in_world(heavy_delivery, w3)), by(rule("ev-range-worlds.pl", clause(26))),
        ...
        uses([
          proof(goal(trip_data(heavy_delivery, 180, 80, 15, 700, 55, 0.22)), by(fact("ev-range-worlds.pl", clause(11)))),
          proof(
            goal(required_energy(heavy_delivery, w3, 59.201999999999998)), by(rule("ev-range-worlds.pl", clause(24))),
            ...
            uses([
              ...
              proof(goal(mul(45.539999999999999, 1.30, 59.201999999999998)), by(builtin(mul, 3)))
            ])
          ),
          proof(goal(gt(59.201999999999998, 55)), by(builtin(gt, 2)))
        ])
      )
    ])
  )
...
why(
  reason(winter_highway, "cold fast payload trip exceeds battery in physics-aware worlds"),
  proof(
    goal(reason(winter_highway, "cold fast payload trip exceeds battery in physics-aware worlds")), by(rule("ev-range-worlds.pl", clause(29))),
    uses([
      proof(
        goal(risky_in_world(winter_highway, w0)), by(rule("ev-range-worlds.pl", clause(26))),
        bindings([binding("T", winter_highway), binding("W", w0), binding("__anon44", 260), binding("__anon45", 115), binding("__anon46", -5), binding("__anon47", 400), binding("Battery", 60), binding("__anon48", 0.20), binding("Required", 77.500799999999998)]),
...
why(
  reason(heavy_delivery, "safety buffer turns a physics-safe delivery into a cautious risk"),
  proof(
    goal(reason(heavy_delivery, "safety buffer turns a physics-safe delivery into a cautious risk")), by(rule("ev-range-worlds.pl", clause(30))),
    uses([
      proof(
        goal(safe_in_world(heavy_delivery, w0)), by(rule("ev-range-worlds.pl", clause(25))),
        bindings([binding("T", heavy_delivery), binding("W", w0), binding("__anon39", 180), binding("__anon40", 80), binding("__anon41", 15), binding("__anon42", 700), binding("Battery", 55), binding("__anon43", 0.22), binding("Required", 45.539999999999999)]),
...
why(
  status(ev_range_worlds, expected_world_pattern),
  proof(
    goal(status(ev_range_worlds, expected_world_pattern)), by(rule("ev-range-worlds.pl", clause(31))),
    uses([
      proof(
        goal(safe_in_world(city_errand, w3)), by(rule("ev-range-worlds.pl", clause(25))),
        bindings([binding("T", city_errand), binding("W", w3), binding("__anon39", 40), binding("__anon40", 45), binding("__anon41", 20), binding("__anon42", 100), binding("Battery", 30), binding("__anon43", 0.18), binding("Required", 9.3599999999999994)]),
