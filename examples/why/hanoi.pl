...
why(
  answer(3, [[left, right], [left, center], [right, center], [left, right], [center, left], [center, right], [left, right]]),
  proof(
    goal(answer(3, [[left, right], [left, center], [right, center], [left, right], [center, left], [center, right], [left, right]])), by(rule("hanoi.pl", clause(5))),
    bindings([binding("Moves", [[left, right], [left, center], [right, center], [left, right], [center, left], [center, right], [left, right]])]),
    uses([
      proof(
        goal(hanoi(3, left, right, center, [[left, right], [left, center], [right, center], [left, right], [center, left], [center, right], [left, right]])), by(rule("hanoi.pl", clause(4))),
        ...
        uses([
          ...
          proof(
            goal(hanoi(2, left, center, right, [[left, right], [left, center], [right, center]])), by(rule("hanoi.pl", clause(4))),
            ...
            uses([
              ...
              proof(
                goal(hanoi(1, left, right, center, [[left, right]])), by(rule("hanoi.pl", clause(4))),
                ...
                uses([
                  ...
                  proof(
                    goal(hanoi(0, left, center, right, [])), by(fact("hanoi.pl", clause(3))),
                    bindings([binding("_From", left), binding("_To", center), binding("_Via", right)])
                  ),
                  proof(
                    goal(hanoi(0, center, right, left, [])), by(fact("hanoi.pl", clause(3))),
                    bindings([binding("_From", center), binding("_To", right), binding("_Via", left)])
                  ),
                  proof(goal(append([], [[left, right]], [[left, right]])), by(builtin(append, 3)))
                ])
              ),
              proof(
                goal(hanoi(1, right, center, left, [[right, center]])), by(rule("hanoi.pl", clause(4))),
                ...
                uses([
                  ...
                  proof(goal(sub(1, 1, 0)), by(builtin(sub, 3))),
                  proof(
                    goal(hanoi(0, right, left, center, [])), by(fact("hanoi.pl", clause(3))),
                  ...
                  proof(goal(append([], [[right, center]], [[right, center]])), by(builtin(append, 3)))
                ])
              ),
              proof(goal(append([[left, right]], [[left, center], [right, center]], [[left, right], [left, center], [right, center]])), by(builtin(append, 3)))
            ])
          ),
          proof(
            goal(hanoi(2, center, right, left, [[center, left], [center, right], [left, right]])), by(rule("hanoi.pl", clause(4))),
            ...
            uses([
              ...
              proof(goal(sub(2, 1, 1)), by(builtin(sub, 3))),
              proof(
                goal(hanoi(1, center, left, right, [[center, left]])), by(rule("hanoi.pl", clause(4))),
                ...
                uses([
                  ...
                  proof(goal(append([], [[center, left]], [[center, left]])), by(builtin(append, 3)))
                ])
              ),
              proof(
                goal(hanoi(1, left, right, center, [[left, right]])), by(rule("hanoi.pl", clause(4))),
              ...
              proof(goal(append([[center, left]], [[center, right], [left, right]], [[center, left], [center, right], [left, right]])), by(builtin(append, 3)))
            ])
          ),
          proof(goal(append([[left, right], [left, center], [right, center]], [[left, right], [center, left], [center, right], [left, right]], [[left, right], [left, center], [right, center], [left, right], [center, left], [center, right], [left, right]])), by(builtin(append, 3)))
        ])
      )
    ])
  )
