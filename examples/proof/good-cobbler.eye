...
substitution(1, []).
proof(1, is(joe, [good, Cobbler]), rule(1, at(5, 1)), []).
substitution(2, [binding("person", joe), binding("occupation", Cobbler)]).
proof(2, report(quoted([triple(joe, is, [good, Cobbler])])), rule(2, at(6, 1)), [uses(1, is(joe, [good, Cobbler]))]).
