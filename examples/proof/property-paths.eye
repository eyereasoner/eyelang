...
query(1, at(9, 1), [call(grandparent_of(?v0, ?v1))], [binding("person", ?v0), binding("grandchild", ?v1)]).
result(1, complete, 1).
answer(1, [binding("person", alice), binding("grandchild", carol)]).
why(1, [binding("person", alice), binding("grandchild", carol)], 5).
query(2, at(10, 1), [call(has_parent(?v0, ?v1))], [binding("child", ?v0), binding("parent", ?v1)]).
result(2, complete, 2).
...
substitution(1, []).
proof(1, parent_of(alice, bob), rule(1, at(4, 1)), []).
substitution(2, []).
proof(2, parent_of(bob, carol), rule(2, at(5, 1)), []).
substitution(3, []).
proof(3, parent_of(bob, carol), rule(2, at(5, 1)), []).
substitution(4, [binding("x", alice), binding("z", carol), binding("y", bob)]).
proof(4, grandparent_of(alice, carol), rule(3, at(6, 1)), [uses(1, parent_of(alice, bob)), uses(3, parent_of(bob, carol))]).
...
substitution(6, []).
proof(6, parent_of(alice, bob), rule(1, at(4, 1)), []).
substitution(7, []).
proof(7, parent_of(bob, carol), rule(2, at(5, 1)), []).
substitution(8, [binding("child", bob), binding("parent", alice)]).
proof(8, has_parent(bob, alice), rule(4, at(7, 1)), [uses(6, parent_of(alice, bob))]).
substitution(9, [binding("child", carol), binding("parent", bob)]).
proof(9, has_parent(carol, bob), rule(4, at(7, 1)), [uses(7, parent_of(bob, carol))]).
