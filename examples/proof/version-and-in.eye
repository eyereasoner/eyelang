...
proof(7, level(alice, gold), rule(1, at(2, 1)), []).
proof(8, level(bob, bronze), rule(2, at(2, 21)), []).
proof(9, level(carol, platinum), rule(3, at(2, 41)), []).
proof(10, level(alice, gold), rule(1, at(2, 1)), []).
proof(11, priority(alice), rule(4, at(3, 1)), [uses(10, level(alice, gold))]).
proof(12, solution([]), query, [uses(11, priority(alice))]).
proof(13, ordinary(bob), rule(6, at(4, 1)), [uses(8, level(bob, bronze)), absent(priority(bob), complete)]).
proof(14, level(carol, platinum), rule(3, at(2, 41)), []).
proof(15, priority(carol), rule(5, at(3, 34)), [uses(14, level(carol, platinum))]).
