...
query(1, at(25, 1), [call(name(?v0, ?v1))], [binding("person", ?v0), binding("text", ?v1)]).
result(1, complete, 1).
...
query(2, at(26, 1), [call(annotation(?v0, ?v1, ?v2, ?v3, ?v4))], [binding("subject", ?v0), binding("predicate", ?v1), binding("object", ?v2), binding("source", ?v3), binding("graph", ?v4)]).
result(2, complete, 1).
...
query(3, at(27, 1), [call(rdf(iri("https://example/document"), iri("https://example/title"), ?v0, ?v1))], [binding("title", ?v0), binding("graph", ?v1)]).
result(3, complete, 1).
...
substitution(1, []).
proof(1, rdf(iri("https://example/alice"), iri("https://example/name"), literal("Alice", datatype(iri("http://www.w3.org/2001/XMLSchema#string"))), default_graph), rule(1, at(1, 1)), []).
substitution(2, [binding("person", iri("https://example/alice")), binding("text", "Alice")]).
proof(2, name(iri("https://example/alice"), "Alice"), rule(7, at(11, 1)), [uses(1, rdf(iri("https://example/alice"), iri("https://example/name"), literal("Alice", datatype(iri("http://www.w3.org/2001/XMLSchema#string"))), default_graph))]).
...
substitution(4, []).
proof(4, rdf(blank("d0_claim"), iri("http://www.w3.org/1999/02/22-rdf-syntax-ns#reifies"), triple(iri("https://example/alice"), iri("https://example/knows"), iri("https://example/bob")), iri("https://example/graph")), rule(5, at(5, 1)), []).
substitution(5, []).
proof(5, rdf(blank("d0_claim"), iri("https://example/source"), iri("https://example/chat"), iri("https://example/graph")), rule(6, at(6, 1)), []).
...
substitution(8, []).
proof(8, rdf(iri("https://example/document"), iri("https://example/title"), literal("HTML و CSS", language("ar", rtl)), iri("https://example/graph")), rule(4, at(4, 1)), []).
