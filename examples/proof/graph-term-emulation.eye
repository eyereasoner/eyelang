...
proof(4, contains(g1, triple(alice, knows, bob)), rule(4, at(5, 1)), [uses(1, graph_term(g1, graph([triple(alice, knows, bob), triple(bob, knows, carol)])))]).
substitution(5, [binding("graph", g1), binding("s", alice), binding("o", bob)]).
proof(5, social(g1), rule(8, at(8, 1)), [uses(4, contains(g1, triple(alice, knows, bob)))]).
substitution(6, [binding("x", triple(bob, knows, carol)), binding("tail", [])]).
proof(6, member(triple(bob, knows, carol), [triple(bob, knows, carol)]), rule(6, at(7, 1)), []).
...
proof(8, contains(g1, triple(bob, knows, carol)), rule(5, at(6, 1)), [uses(2, graph_term(g1, graph([triple(alice, knows, bob), triple(bob, knows, carol)]))), uses(6, member(triple(bob, knows, carol), [triple(bob, knows, carol)]))]).
substitution(9, []).
proof(9, graph_term(g1, graph([triple(alice, knows, bob), triple(bob, knows, carol)])), rule(1, at(2, 1)), []).
substitution(10, []).
proof(10, graph_term(g2, graph([triple(alice, likes, tea)])), rule(2, at(3, 1)), []).
substitution(11, []).
proof(11, graph_term(g1, graph([triple(alice, knows, bob), triple(bob, knows, carol)])), rule(1, at(2, 1)), []).
substitution(12, []).
proof(12, graph_term(g2, graph([triple(alice, likes, tea)])), rule(2, at(3, 1)), []).
substitution(13, [binding("graph", g1), binding("statement", triple(alice, knows, bob)), binding("rest", [triple(bob, knows, carol)])]).
proof(13, contains(g1, triple(alice, knows, bob)), rule(4, at(5, 1)), [uses(9, graph_term(g1, graph([triple(alice, knows, bob), triple(bob, knows, carol)])))]).
substitution(14, [binding("graph", g2), binding("statement", triple(alice, likes, tea)), binding("rest", [])]).
proof(14, contains(g2, triple(alice, likes, tea)), rule(4, at(5, 1)), [uses(10, graph_term(g2, graph([triple(alice, likes, tea)])))]).
substitution(15, [binding("graph", g1), binding("subject", alice), binding("predicate", knows), binding("object", bob)]).
proof(15, mentions(g1, alice), rule(9, at(9, 1)), [uses(13, contains(g1, triple(alice, knows, bob)))]).
substitution(16, [binding("graph", g2), binding("subject", alice), binding("predicate", likes), binding("object", tea)]).
proof(16, mentions(g2, alice), rule(9, at(9, 1)), [uses(14, contains(g2, triple(alice, likes, tea)))]).
substitution(17, [binding("graph", g1), binding("object", bob), binding("subject", alice), binding("predicate", knows)]).
proof(17, mentions(g1, bob), rule(10, at(10, 1)), [uses(13, contains(g1, triple(alice, knows, bob)))]).
substitution(18, [binding("graph", g2), binding("object", tea), binding("subject", alice), binding("predicate", likes)]).
proof(18, mentions(g2, tea), rule(10, at(10, 1)), [uses(14, contains(g2, triple(alice, likes, tea)))]).
substitution(19, [binding("x", triple(bob, knows, carol)), binding("tail", [])]).
proof(19, member(triple(bob, knows, carol), [triple(bob, knows, carol)]), rule(6, at(7, 1)), []).
...
proof(24, contains(g1, triple(bob, knows, carol)), rule(5, at(6, 1)), [uses(11, graph_term(g1, graph([triple(alice, knows, bob), triple(bob, knows, carol)]))), uses(19, member(triple(bob, knows, carol), [triple(bob, knows, carol)]))]).
substitution(25, [binding("graph", g1), binding("object", carol), binding("subject", bob), binding("predicate", knows)]).
proof(25, mentions(g1, carol), rule(10, at(10, 1)), [uses(24, contains(g1, triple(bob, knows, carol)))]).
