...
query(1, at(17, 1), [call(must_have(?v0, ?v1))], [binding("person", ?v0), binding("license", ?v1)]).
result(1, complete, 1).
answer(1, [binding("person", alice), binding("license", dogLicense)]).
why(1, [binding("person", alice), binding("license", dogLicense)], 69).
query(2, at(18, 1), [call(dog_count(?v0, ?v1))], [binding("person", ?v0), binding("count", ?v1)]).
result(2, complete, 2).
...
substitution(1, []).
proof(1, has_dog(alice, dog1), rule(1, at(4, 1)), []).
substitution(2, []).
proof(2, has_dog(alice, dog2), rule(2, at(5, 1)), []).
substitution(3, []).
proof(3, has_dog(alice, dog3), rule(3, at(6, 1)), []).
substitution(4, []).
proof(4, has_dog(alice, dog4), rule(4, at(7, 1)), []).
substitution(5, []).
proof(5, has_dog(alice, dog5), rule(5, at(8, 1)), []).
substitution(6, []).
proof(6, has_dog(bob, dog6), rule(6, at(9, 1)), []).
substitution(7, []).
proof(7, has_dog(bob, dog7), rule(7, at(10, 1)), []).
substitution(8, []).
proof(8, has_dog(alice, dog1), rule(1, at(4, 1)), []).
substitution(9, []).
proof(9, has_dog(alice, dog2), rule(2, at(5, 1)), []).
substitution(10, []).
proof(10, has_dog(alice, dog3), rule(3, at(6, 1)), []).
substitution(11, []).
proof(11, has_dog(alice, dog4), rule(4, at(7, 1)), []).
substitution(12, []).
proof(12, has_dog(alice, dog5), rule(5, at(8, 1)), []).
...
proof(18, dog_count(alice, 5), rule(8, at(12, 1)), [uses(1, has_dog(alice, dog1)), collected([dog1, dog2, dog3, dog4, dog5], ?v0, [call(has_dog(alice, ?v0))], [13, 14, 15, 16, 17], complete), calculated(5, function("count", [value([dog1, dog2, dog3, dog4, dog5])]))]).
substitution(19, []).
proof(19, has_dog(alice, dog1), rule(1, at(4, 1)), []).
substitution(20, []).
proof(20, has_dog(alice, dog2), rule(2, at(5, 1)), []).
substitution(21, []).
proof(21, has_dog(alice, dog3), rule(3, at(6, 1)), []).
substitution(22, []).
proof(22, has_dog(alice, dog4), rule(4, at(7, 1)), []).
substitution(23, []).
proof(23, has_dog(alice, dog5), rule(5, at(8, 1)), []).
...
substitution(29, []).
proof(29, has_dog(alice, dog1), rule(1, at(4, 1)), []).
substitution(30, []).
proof(30, has_dog(alice, dog2), rule(2, at(5, 1)), []).
substitution(31, []).
proof(31, has_dog(alice, dog3), rule(3, at(6, 1)), []).
substitution(32, []).
proof(32, has_dog(alice, dog4), rule(4, at(7, 1)), []).
substitution(33, []).
proof(33, has_dog(alice, dog5), rule(5, at(8, 1)), []).
...
substitution(39, []).
proof(39, has_dog(alice, dog1), rule(1, at(4, 1)), []).
substitution(40, []).
proof(40, has_dog(alice, dog2), rule(2, at(5, 1)), []).
substitution(41, []).
proof(41, has_dog(alice, dog3), rule(3, at(6, 1)), []).
substitution(42, []).
proof(42, has_dog(alice, dog4), rule(4, at(7, 1)), []).
substitution(43, []).
proof(43, has_dog(alice, dog5), rule(5, at(8, 1)), []).
...
substitution(49, []).
proof(49, has_dog(alice, dog1), rule(1, at(4, 1)), []).
substitution(50, []).
proof(50, has_dog(alice, dog2), rule(2, at(5, 1)), []).
substitution(51, []).
proof(51, has_dog(alice, dog3), rule(3, at(6, 1)), []).
substitution(52, []).
proof(52, has_dog(alice, dog4), rule(4, at(7, 1)), []).
substitution(53, []).
proof(53, has_dog(alice, dog5), rule(5, at(8, 1)), []).
...
substitution(59, []).
proof(59, has_dog(bob, dog6), rule(6, at(9, 1)), []).
substitution(60, []).
proof(60, has_dog(bob, dog7), rule(7, at(10, 1)), []).
...
proof(63, dog_count(bob, 2), rule(8, at(12, 1)), [uses(6, has_dog(bob, dog6)), collected([dog6, dog7], ?v0, [call(has_dog(bob, ?v0))], [61, 62], complete), calculated(2, function("count", [value([dog6, dog7])]))]).
substitution(64, []).
proof(64, has_dog(bob, dog6), rule(6, at(9, 1)), []).
substitution(65, []).
proof(65, has_dog(bob, dog7), rule(7, at(10, 1)), []).
...
proof(68, must_have(alice, dogLicense), rule(9, at(15, 1)), [uses(18, dog_count(alice, 5)), compared(">", 5, 4)]).
...
substitution(70, []).
proof(70, has_dog(alice, dog1), rule(1, at(4, 1)), []).
substitution(71, []).
proof(71, has_dog(alice, dog2), rule(2, at(5, 1)), []).
substitution(72, []).
proof(72, has_dog(alice, dog3), rule(3, at(6, 1)), []).
substitution(73, []).
proof(73, has_dog(alice, dog4), rule(4, at(7, 1)), []).
substitution(74, []).
proof(74, has_dog(alice, dog5), rule(5, at(8, 1)), []).
substitution(75, []).
proof(75, has_dog(bob, dog6), rule(6, at(9, 1)), []).
substitution(76, []).
proof(76, has_dog(bob, dog7), rule(7, at(10, 1)), []).
substitution(77, []).
proof(77, has_dog(alice, dog1), rule(1, at(4, 1)), []).
substitution(78, []).
proof(78, has_dog(alice, dog2), rule(2, at(5, 1)), []).
substitution(79, []).
proof(79, has_dog(alice, dog3), rule(3, at(6, 1)), []).
substitution(80, []).
proof(80, has_dog(alice, dog4), rule(4, at(7, 1)), []).
substitution(81, []).
proof(81, has_dog(alice, dog5), rule(5, at(8, 1)), []).
...
proof(87, dog_count(alice, 5), rule(8, at(12, 1)), [uses(70, has_dog(alice, dog1)), collected([dog1, dog2, dog3, dog4, dog5], ?v0, [call(has_dog(alice, ?v0))], [82, 83, 84, 85, 86], complete), calculated(5, function("count", [value([dog1, dog2, dog3, dog4, dog5])]))]).
substitution(88, []).
proof(88, has_dog(alice, dog1), rule(1, at(4, 1)), []).
substitution(89, []).
proof(89, has_dog(alice, dog2), rule(2, at(5, 1)), []).
substitution(90, []).
proof(90, has_dog(alice, dog3), rule(3, at(6, 1)), []).
substitution(91, []).
proof(91, has_dog(alice, dog4), rule(4, at(7, 1)), []).
substitution(92, []).
proof(92, has_dog(alice, dog5), rule(5, at(8, 1)), []).
...
substitution(98, []).
proof(98, has_dog(alice, dog1), rule(1, at(4, 1)), []).
substitution(99, []).
proof(99, has_dog(alice, dog2), rule(2, at(5, 1)), []).
substitution(100, []).
proof(100, has_dog(alice, dog3), rule(3, at(6, 1)), []).
substitution(101, []).
proof(101, has_dog(alice, dog4), rule(4, at(7, 1)), []).
substitution(102, []).
proof(102, has_dog(alice, dog5), rule(5, at(8, 1)), []).
...
substitution(108, []).
proof(108, has_dog(alice, dog1), rule(1, at(4, 1)), []).
substitution(109, []).
proof(109, has_dog(alice, dog2), rule(2, at(5, 1)), []).
substitution(110, []).
proof(110, has_dog(alice, dog3), rule(3, at(6, 1)), []).
substitution(111, []).
proof(111, has_dog(alice, dog4), rule(4, at(7, 1)), []).
substitution(112, []).
proof(112, has_dog(alice, dog5), rule(5, at(8, 1)), []).
...
substitution(118, []).
proof(118, has_dog(alice, dog1), rule(1, at(4, 1)), []).
substitution(119, []).
proof(119, has_dog(alice, dog2), rule(2, at(5, 1)), []).
substitution(120, []).
proof(120, has_dog(alice, dog3), rule(3, at(6, 1)), []).
substitution(121, []).
proof(121, has_dog(alice, dog4), rule(4, at(7, 1)), []).
substitution(122, []).
proof(122, has_dog(alice, dog5), rule(5, at(8, 1)), []).
...
substitution(128, []).
proof(128, has_dog(bob, dog6), rule(6, at(9, 1)), []).
substitution(129, []).
proof(129, has_dog(bob, dog7), rule(7, at(10, 1)), []).
...
proof(132, dog_count(bob, 2), rule(8, at(12, 1)), [uses(75, has_dog(bob, dog6)), collected([dog6, dog7], ?v0, [call(has_dog(bob, ?v0))], [130, 131], complete), calculated(2, function("count", [value([dog6, dog7])]))]).
substitution(133, []).
proof(133, has_dog(bob, dog6), rule(6, at(9, 1)), []).
substitution(134, []).
proof(134, has_dog(bob, dog7), rule(7, at(10, 1)), []).
