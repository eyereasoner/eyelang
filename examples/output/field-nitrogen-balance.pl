...
why(
  status(low_input, under_supplied),
  proof(
    goal(status(low_input, under_supplied)),
    by(rule("field-nitrogen-balance.pl", clause(19))),
    bindings([binding("F", low_input), binding("D", 51.5)]),
    uses([
      proof(
        goal(deficit_n(low_input, 51.5)),
        by(rule("field-nitrogen-balance.pl", clause(16))),
        ...
        uses([
          proof(
            goal(available_n(low_input, 58.5)),
            by(rule("field-nitrogen-balance.pl", clause(13))),
            ...
            uses([
              proof(
                goal(total_n(low_input, 65)),
                by(rule("field-nitrogen-balance.pl", clause(12))),
                bindings([binding("F", low_input), binding("Total", 65), binding("Soil", 25), binding("Fert", 40), binding("__anon0", 0.10), binding("__anon1", 110)]),
                uses([
                  proof(
                    goal(field(low_input, 25, 40, 0.10, 110)),
                    by(fact("field-nitrogen-balance.pl", clause(8)))
                  ),
                  proof(
                    goal(add(25, 40, 65)),
                    by(builtin(add, 3))
              ...
              proof(
                goal(sub(1.0, 0.10, 0.90000000000000002)),
                by(builtin(sub, 3))
              ),
              proof(
                goal(mul(65, 0.90000000000000002, 58.5)),
                by(builtin(mul, 3))
              )
            ])
          ),
...
why(
  status(balanced_loam, balanced),
  proof(
    goal(status(balanced_loam, balanced)),
    by(rule("field-nitrogen-balance.pl", clause(20))),
    bindings([binding("F", balanced_loam), binding("D", 0.0), binding("S", 0.0)]),
    uses([
      proof(
        goal(deficit_n(balanced_loam, 0.0)),
        by(rule("field-nitrogen-balance.pl", clause(17))),
        ...
        uses([
          proof(
            goal(available_n(balanced_loam, 110.0)),
            by(rule("field-nitrogen-balance.pl", clause(13))),
            ...
            uses([
              proof(
                goal(total_n(balanced_loam, 125)),
                by(rule("field-nitrogen-balance.pl", clause(12))),
                ...
                uses([
                  proof(
                    goal(field(balanced_loam, 45, 80, 0.12, 110)),
                    by(fact("field-nitrogen-balance.pl", clause(9)))
                  ),
                  proof(
                    goal(add(45, 80, 125)),
                    by(builtin(add, 3))
              ...
              proof(
                goal(sub(1.0, 0.12, 0.88)),
                by(builtin(sub, 3))
              ),
              proof(
                goal(mul(125, 0.88, 110.0)),
                by(builtin(mul, 3))
              )
            ])
          ),
      ...
      proof(
        goal(surplus_n(balanced_loam, 0.0)),
        by(rule("field-nitrogen-balance.pl", clause(15))),
...
why(
  status(sandy_high, over_supplied),
  proof(
    goal(status(sandy_high, over_supplied)),
    by(rule("field-nitrogen-balance.pl", clause(21))),
    bindings([binding("F", sandy_high), binding("S", 12.0)]),
    uses([
      proof(
        goal(surplus_n(sandy_high, 12.0)),
        by(rule("field-nitrogen-balance.pl", clause(14))),
        ...
        uses([
          proof(
            goal(available_n(sandy_high, 117.0)),
            by(rule("field-nitrogen-balance.pl", clause(13))),
            ...
            uses([
              proof(
                ...
                uses([
                  proof(
                    goal(field(sandy_high, 30, 150, 0.35, 105)),
                    by(fact("field-nitrogen-balance.pl", clause(10)))
                  ),
                  proof(
                    goal(add(30, 150, 180)),
                    by(builtin(add, 3))
              ...
              proof(
                goal(sub(1.0, 0.35, 0.65000000000000002)),
                by(builtin(sub, 3))
              ),
              proof(
                goal(mul(180, 0.65000000000000002, 117.0)),
                by(builtin(mul, 3))
              )
            ])
          ),
...
why(
  status(clay_surplus, over_supplied),
  proof(
    goal(status(clay_surplus, over_supplied)),
    by(rule("field-nitrogen-balance.pl", clause(21))),
    bindings([binding("F", clay_surplus), binding("S", 27.200000000000017)]),
    uses([
      proof(
        goal(surplus_n(clay_surplus, 27.200000000000017)),
        by(rule("field-nitrogen-balance.pl", clause(14))),
        ...
        uses([
          proof(
            goal(available_n(clay_surplus, 147.20000000000002)),
            by(rule("field-nitrogen-balance.pl", clause(13))),
            ...
            uses([
              proof(
                ...
                uses([
                  proof(
                    goal(field(clay_surplus, 70, 90, 0.08, 120)),
                    by(fact("field-nitrogen-balance.pl", clause(11)))
                  ),
                  proof(
                    goal(add(70, 90, 160)),
                    by(builtin(add, 3))
              ...
              proof(
                goal(sub(1.0, 0.08, 0.92000000000000004)),
                by(builtin(sub, 3))
              ),
              proof(
                goal(mul(160, 0.92000000000000004, 147.20000000000002)),
                by(builtin(mul, 3))
              )
            ])
          ),
          ...
          proof(
            goal(gt(147.20000000000002, 120)),
            by(builtin(gt, 2))
          ),
          proof(
            goal(sub(147.20000000000002, 120, 27.200000000000017)),
            by(builtin(sub, 3))
          )
        ])
      ),
      proof(
        goal(gt(27.200000000000017, 10.0)),
        by(builtin(gt, 2))
      )
    ])
  )
...
why(
  availableN_kg_ha(low_input, 58.5),
  proof(
    goal(availableN_kg_ha(low_input, 58.5)),
    by(rule("field-nitrogen-balance.pl", clause(22))),
...
why(
  availableN_kg_ha(balanced_loam, 110.0),
  proof(
    goal(availableN_kg_ha(balanced_loam, 110.0)),
    by(rule("field-nitrogen-balance.pl", clause(22))),
...
why(
  availableN_kg_ha(sandy_high, 117.0),
  proof(
    goal(availableN_kg_ha(sandy_high, 117.0)),
    by(rule("field-nitrogen-balance.pl", clause(22))),
...
why(
  availableN_kg_ha(clay_surplus, 147.20000000000002),
  proof(
    goal(availableN_kg_ha(clay_surplus, 147.20000000000002)),
    by(rule("field-nitrogen-balance.pl", clause(22))),
...
why(
  deficitN_kg_ha(low_input, 51.5),
  proof(
    goal(deficitN_kg_ha(low_input, 51.5)),
    by(rule("field-nitrogen-balance.pl", clause(23))),
    bindings([binding("F", low_input), binding("D", 51.5)]),
    uses([
      proof(
        goal(deficit_n(low_input, 51.5)),
...
why(
  deficitN_kg_ha(balanced_loam, 0.0),
  proof(
    goal(deficitN_kg_ha(balanced_loam, 0.0)),
    by(rule("field-nitrogen-balance.pl", clause(23))),
...
why(
  deficitN_kg_ha(sandy_high, 0.0),
  proof(
    goal(deficitN_kg_ha(sandy_high, 0.0)),
    by(rule("field-nitrogen-balance.pl", clause(23))),
    bindings([binding("F", sandy_high), binding("D", 0.0)]),
    uses([
      proof(
        goal(deficit_n(sandy_high, 0.0)),
        by(rule("field-nitrogen-balance.pl", clause(17))),
...
why(
  deficitN_kg_ha(clay_surplus, 0.0),
  proof(
    goal(deficitN_kg_ha(clay_surplus, 0.0)),
    by(rule("field-nitrogen-balance.pl", clause(23))),
    bindings([binding("F", clay_surplus), binding("D", 0.0)]),
    uses([
      proof(
        goal(deficit_n(clay_surplus, 0.0)),
        by(rule("field-nitrogen-balance.pl", clause(17))),
        ...
        uses([
          ...
          proof(
            goal(ge(147.20000000000002, 120)),
            by(builtin(ge, 2))
          )
        ])
      )
...
why(
  surplusN_kg_ha(sandy_high, 12.0),
  proof(
    goal(surplusN_kg_ha(sandy_high, 12.0)),
    by(rule("field-nitrogen-balance.pl", clause(24))),
    bindings([binding("F", sandy_high), binding("S", 12.0)]),
    uses([
      proof(
        goal(surplus_n(sandy_high, 12.0)),
...
why(
  surplusN_kg_ha(clay_surplus, 27.200000000000017),
  proof(
    goal(surplusN_kg_ha(clay_surplus, 27.200000000000017)),
    by(rule("field-nitrogen-balance.pl", clause(24))),
    bindings([binding("F", clay_surplus), binding("S", 27.200000000000017)]),
    uses([
      proof(
...
why(
  surplusN_kg_ha(low_input, 0.0),
  proof(
    goal(surplusN_kg_ha(low_input, 0.0)),
    by(rule("field-nitrogen-balance.pl", clause(24))),
    bindings([binding("F", low_input), binding("S", 0.0)]),
    uses([
      proof(
        goal(surplus_n(low_input, 0.0)),
        by(rule("field-nitrogen-balance.pl", clause(15))),
...
why(
  surplusN_kg_ha(balanced_loam, 0.0),
  proof(
    goal(surplusN_kg_ha(balanced_loam, 0.0)),
    by(rule("field-nitrogen-balance.pl", clause(24))),
...
why(
  leachingIndex(sandy_high, 4.1999999999999993),
  proof(
    goal(leachingIndex(sandy_high, 4.1999999999999993)),
    by(rule("field-nitrogen-balance.pl", clause(25))),
    bindings([binding("F", sandy_high), binding("I", 4.1999999999999993)]),
    uses([
      proof(
        goal(leaching_index(sandy_high, 4.1999999999999993)),
        by(rule("field-nitrogen-balance.pl", clause(18))),
        ...
        uses([
          ...
          proof(
            goal(mul(12.0, 0.35, 4.1999999999999993)),
            by(builtin(mul, 3))
          )
        ])
      )
...
why(
  leachingIndex(clay_surplus, 2.1760000000000015),
  proof(
    goal(leachingIndex(clay_surplus, 2.1760000000000015)),
    by(rule("field-nitrogen-balance.pl", clause(25))),
    bindings([binding("F", clay_surplus), binding("I", 2.1760000000000015)]),
    uses([
      proof(
        goal(leaching_index(clay_surplus, 2.1760000000000015)),
        by(rule("field-nitrogen-balance.pl", clause(18))),
        ...
        uses([
          ...
          proof(
            goal(mul(27.200000000000017, 0.08, 2.1760000000000015)),
            by(builtin(mul, 3))
          )
        ])
      )
...
why(
  leachingIndex(low_input, 0.0),
  proof(
    goal(leachingIndex(low_input, 0.0)),
    by(rule("field-nitrogen-balance.pl", clause(25))),
    bindings([binding("F", low_input), binding("I", 0.0)]),
    uses([
      proof(
        goal(leaching_index(low_input, 0.0)),
        by(rule("field-nitrogen-balance.pl", clause(18))),
...
why(
  leachingIndex(balanced_loam, 0.0),
  proof(
    goal(leachingIndex(balanced_loam, 0.0)),
    by(rule("field-nitrogen-balance.pl", clause(25))),
    bindings([binding("F", balanced_loam), binding("I", 0.0)]),
    uses([
      proof(
        goal(leaching_index(balanced_loam, 0.0)),
        by(rule("field-nitrogen-balance.pl", clause(18))),
...
why(
  highestLeachingRisk(field_nitrogen_balance, sandy_high),
  proof(
    goal(highestLeachingRisk(field_nitrogen_balance, sandy_high)),
    by(rule("field-nitrogen-balance.pl", clause(26))),
    ...
    uses([
      ...
      proof(
        goal(gt(4.1999999999999993, 2.1760000000000015)),
        by(builtin(gt, 2))
      )
    ])
  )
