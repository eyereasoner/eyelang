...
triple(:PolicyGraph1, :contains, edge(:PermChangeTerms, :clause, :ClauseC2)).
triple(:PolicyGraph1, :contains, edge(:PermChangeTerms, :noticeDays, 3)).
triple(:PolicyGraph1, :contains, edge(:PermChangeTerms, odrl:action, tosl:changeTerms)).
triple(:PolicyGraph1, :contains, edge(:PermChangeTerms, odrl:assignee, :ConsumerExample)).
triple(:PolicyGraph1, :contains, edge(:PermChangeTerms, odrl:assigner, :Provider)).
triple(:PolicyGraph1, :contains, edge(:PermChangeTerms, odrl:duty, odrl:inform)).
triple(:PolicyGraph1, :contains, edge(:PermChangeTerms, odrl:target, :AgreementText)).
triple(:PolicyGraph1, :contains, edge(:PermDeleteAccount, :clause, :ClauseC1)).
triple(:PolicyGraph1, :contains, edge(:PermDeleteAccount, odrl:action, tosl:removeAccount)).
triple(:PolicyGraph1, :contains, edge(:PermDeleteAccount, odrl:assignee, :ConsumerExample)).
triple(:PolicyGraph1, :contains, edge(:PermDeleteAccount, odrl:assigner, :Provider)).
triple(:PolicyGraph1, :contains, edge(:PermDeleteAccount, odrl:target, :UserAccount)).
triple(:PolicyGraph1, :contains, edge(:PermShareData, :clause, :ClauseC3)).
triple(:PolicyGraph1, :contains, edge(:PermShareData, odrl:action, tosl:shareData)).
triple(:PolicyGraph1, :contains, edge(:PermShareData, odrl:assignee, :ConsumerExample)).
triple(:PolicyGraph1, :contains, edge(:PermShareData, odrl:assigner, :Provider)).
triple(:PolicyGraph1, :contains, edge(:PermShareData, odrl:target, :UserData)).
triple(:PolicyGraph1, :contains, edge(:Policy1, odrl:appliesTo, :Agreement1)).
triple(:PolicyGraph1, :contains, edge(:Policy1, odrl:permission, :PermChangeTerms)).
triple(:PolicyGraph1, :contains, edge(:Policy1, odrl:permission, :PermDeleteAccount)).
triple(:PolicyGraph1, :contains, edge(:Policy1, odrl:permission, :PermShareData)).
triple(:PolicyGraph1, :contains, edge(:Policy1, odrl:prohibition, :ProhibitExportData)).
triple(:PolicyGraph1, :contains, edge(:Policy1, rdf:type, odrl:Policy)).
triple(:PolicyGraph1, :contains, edge(:ProhibitExportData, :clause, :ClauseC4)).
triple(:PolicyGraph1, :contains, edge(:ProhibitExportData, odrl:action, tosl:exportData)).
triple(:PolicyGraph1, :contains, edge(:ProhibitExportData, odrl:assignee, :ConsumerExample)).
triple(:PolicyGraph1, :contains, edge(:ProhibitExportData, odrl:assigner, :Provider)).
triple(:PolicyGraph1, :contains, edge(:ProhibitExportData, odrl:target, :UserData)).
