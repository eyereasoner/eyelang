...
why(
  ...
  proof(
    goal(branch(dave, b)),
    by(rule("family-cousins.pl", clause(10))),
    bindings([binding("Person", dave), binding("Branch", b)]),
    uses([
      proof(
        goal(family_statement(dave, seedBranch, b)),
        by(rule("family-cousins.pl", clause(8))),
        ...
        uses([
          proof(
            goal(family_graph(familyGraph, (parent(adam, bob), parent(adam, carol), parent(bob, dave), parent(bob, eve), parent(carol, frank), parent(carol, grace), parent(dave, heidi), parent(eve, ivan), parent(frank, judy), seedBranch(dave, b), seedBranch(eve, b), seedBranch(frank, c), seedBranch(grace, c)))),
            by(fact("family-cousins.pl", clause(7)))
          ),
          proof(
            goal(formula_binary((parent(adam, bob), parent(adam, carol), parent(bob, dave), parent(bob, eve), parent(carol, frank), parent(carol, grace), parent(dave, heidi), parent(eve, ivan), parent(frank, judy), seedBranch(dave, b), seedBranch(eve, b), seedBranch(frank, c), seedBranch(grace, c)), dave, seedBranch, b)),
...
why(
  ...
  proof(
    ...
    uses([
      proof(
        goal(family_statement(eve, seedBranch, b)),
        by(rule("family-cousins.pl", clause(8))),
        ...
        uses([
          ...
          proof(
            goal(formula_binary((parent(adam, bob), parent(adam, carol), parent(bob, dave), parent(bob, eve), parent(carol, frank), parent(carol, grace), parent(dave, heidi), parent(eve, ivan), parent(frank, judy), seedBranch(dave, b), seedBranch(eve, b), seedBranch(frank, c), seedBranch(grace, c)), eve, seedBranch, b)),
            by(builtin(formula_binary, 4))
          )
        ])
      )
...
why(
  ...
  proof(
    ...
    uses([
      proof(
        goal(family_statement(frank, seedBranch, c)),
        by(rule("family-cousins.pl", clause(8))),
        ...
        uses([
          ...
          proof(
            goal(formula_binary((parent(adam, bob), parent(adam, carol), parent(bob, dave), parent(bob, eve), parent(carol, frank), parent(carol, grace), parent(dave, heidi), parent(eve, ivan), parent(frank, judy), seedBranch(dave, b), seedBranch(eve, b), seedBranch(frank, c), seedBranch(grace, c)), frank, seedBranch, c)),
            by(builtin(formula_binary, 4))
          )
        ])
      )
...
why(
  ...
  proof(
    ...
    uses([
      proof(
        goal(family_statement(grace, seedBranch, c)),
        by(rule("family-cousins.pl", clause(8))),
        ...
        uses([
          ...
          proof(
            goal(formula_binary((parent(adam, bob), parent(adam, carol), parent(bob, dave), parent(bob, eve), parent(carol, frank), parent(carol, grace), parent(dave, heidi), parent(eve, ivan), parent(frank, judy), seedBranch(dave, b), seedBranch(eve, b), seedBranch(frank, c), seedBranch(grace, c)), grace, seedBranch, c)),
            by(builtin(formula_binary, 4))
          )
        ])
      )
...
why(
  ...
  proof(
    goal(branch(heidi, b)),
    by(rule("family-cousins.pl", clause(15))),
    bindings([binding("Child", heidi), binding("Branch", b), binding("Parent", dave)]),
    uses([
      proof(
        goal(parent(dave, heidi)),
        by(rule("family-cousins.pl", clause(9))),
        bindings([binding("Parent", dave), binding("Child", heidi)]),
        uses([
          proof(
            goal(family_statement(dave, parent, heidi)),
            by(rule("family-cousins.pl", clause(8))),
            ...
            uses([
              ...
              proof(
                goal(formula_binary((parent(adam, bob), parent(adam, carol), parent(bob, dave), parent(bob, eve), parent(carol, frank), parent(carol, grace), parent(dave, heidi), parent(eve, ivan), parent(frank, judy), seedBranch(dave, b), seedBranch(eve, b), seedBranch(frank, c), seedBranch(grace, c)), dave, parent, heidi)),
                by(builtin(formula_binary, 4))
              )
            ])
          )
...
why(
  ...
  proof(
    ...
    uses([
      proof(
        goal(parent(eve, ivan)),
        by(rule("family-cousins.pl", clause(9))),
        bindings([binding("Parent", eve), binding("Child", ivan)]),
        uses([
          proof(
            goal(family_statement(eve, parent, ivan)),
            by(rule("family-cousins.pl", clause(8))),
            ...
            uses([
              ...
              proof(
                goal(formula_binary((parent(adam, bob), parent(adam, carol), parent(bob, dave), parent(bob, eve), parent(carol, frank), parent(carol, grace), parent(dave, heidi), parent(eve, ivan), parent(frank, judy), seedBranch(dave, b), seedBranch(eve, b), seedBranch(frank, c), seedBranch(grace, c)), eve, parent, ivan)),
                by(builtin(formula_binary, 4))
              )
            ])
          )
...
why(
  ...
  proof(
    ...
    uses([
      proof(
        goal(parent(frank, judy)),
        by(rule("family-cousins.pl", clause(9))),
        bindings([binding("Parent", frank), binding("Child", judy)]),
        uses([
          proof(
            goal(family_statement(frank, parent, judy)),
            by(rule("family-cousins.pl", clause(8))),
            ...
            uses([
              ...
              proof(
                goal(formula_binary((parent(adam, bob), parent(adam, carol), parent(bob, dave), parent(bob, eve), parent(carol, frank), parent(carol, grace), parent(dave, heidi), parent(eve, ivan), parent(frank, judy), seedBranch(dave, b), seedBranch(eve, b), seedBranch(frank, c), seedBranch(grace, c)), frank, parent, judy)),
                by(builtin(formula_binary, 4))
              )
            ])
          )
...
why(
  ...
  proof(
    ...
    uses([
        ...
        uses([
          proof(
            ...
            uses([
              ...
              proof(
                goal(formula_binary((parent(adam, bob), parent(adam, carol), parent(bob, dave), parent(bob, eve), parent(carol, frank), parent(carol, grace), parent(dave, heidi), parent(eve, ivan), parent(frank, judy), seedBranch(dave, b), seedBranch(eve, b), seedBranch(frank, c), seedBranch(grace, c)), adam, parent, bob)),
                by(builtin(formula_binary, 4))
              )
            ])
          )
      ...
      proof(
        goal(generation(adam, 0)),
        by(fact("family-cousins.pl", clause(13)))
      ),
      proof(
        goal(add(0, 1, 1)),
        by(builtin(add, 3))
        ...
        uses([
          proof(
            ...
            uses([
              ...
              proof(
                goal(formula_binary((parent(adam, bob), parent(adam, carol), parent(bob, dave), parent(bob, eve), parent(carol, frank), parent(carol, grace), parent(dave, heidi), parent(eve, ivan), parent(frank, judy), seedBranch(dave, b), seedBranch(eve, b), seedBranch(frank, c), seedBranch(grace, c)), adam, parent, carol)),
                by(builtin(formula_binary, 4))
              )
            ])
          )
        ...
        uses([
          proof(
            ...
            uses([
              ...
              proof(
                goal(formula_binary((parent(adam, bob), parent(adam, carol), parent(bob, dave), parent(bob, eve), parent(carol, frank), parent(carol, grace), parent(dave, heidi), parent(eve, ivan), parent(frank, judy), seedBranch(dave, b), seedBranch(eve, b), seedBranch(frank, c), seedBranch(grace, c)), bob, parent, dave)),
                by(builtin(formula_binary, 4))
              )
            ])
          )
  ...
  proof(
    ...
    uses([
      proof(
        ...
        uses([
          proof(
            goal(family_statement(bob, parent, eve)),
            by(rule("family-cousins.pl", clause(8))),
            ...
            uses([
              ...
              proof(
                goal(formula_binary((parent(adam, bob), parent(adam, carol), parent(bob, dave), parent(bob, eve), parent(carol, frank), parent(carol, grace), parent(dave, heidi), parent(eve, ivan), parent(frank, judy), seedBranch(dave, b), seedBranch(eve, b), seedBranch(frank, c), seedBranch(grace, c)), bob, parent, eve)),
                by(builtin(formula_binary, 4))
              )
            ])
          )
        ...
        uses([
          proof(
            ...
            uses([
              ...
              proof(
                goal(formula_binary((parent(adam, bob), parent(adam, carol), parent(bob, dave), parent(bob, eve), parent(carol, frank), parent(carol, grace), parent(dave, heidi), parent(eve, ivan), parent(frank, judy), seedBranch(dave, b), seedBranch(eve, b), seedBranch(frank, c), seedBranch(grace, c)), carol, parent, frank)),
                by(builtin(formula_binary, 4))
              )
            ])
          )
        ...
        uses([
          proof(
            ...
            uses([
              ...
              proof(
                goal(formula_binary((parent(adam, bob), parent(adam, carol), parent(bob, dave), parent(bob, eve), parent(carol, frank), parent(carol, grace), parent(dave, heidi), parent(eve, ivan), parent(frank, judy), seedBranch(dave, b), seedBranch(eve, b), seedBranch(frank, c), seedBranch(grace, c)), carol, parent, grace)),
                by(builtin(formula_binary, 4))
              )
            ])
          )
...
why(
  cousin(dave, frank),
  proof(
    goal(cousin(dave, frank)),
    by(rule("family-cousins.pl", clause(17))),
    ...
    uses([
      ...
      proof(
        goal(different(b, c)),
        by(fact("family-cousins.pl", clause(11)))
      )
    ])
  )
).
...
why(
  ...
  proof(
    ...
    uses([
      ...
      proof(
        goal(different(c, b)),
        by(fact("family-cousins.pl", clause(12)))
      )
    ])
  )
).
