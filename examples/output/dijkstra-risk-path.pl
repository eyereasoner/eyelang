...
why(
  route(pathB, [depotA, depotB, labD]),
  proof(
    goal(route(pathB, [depotA, depotB, labD])),
    by(rule("dijkstra-risk-path.pl", clause(24))),
    ...
    uses([
      proof(
        goal(path_metrics(pathB, [depotA, depotB, labD], 8.0, 0.5, 13.0, 2)),
        by(rule("dijkstra-risk-path.pl", clause(21))),
        ...
        uses([
          proof(
            goal(candidate(pathB, [depotA, depotB, labD])),
            by(fact("dijkstra-risk-path.pl", clause(13)))
          ),
          proof(
            goal(route_cost([depotA, depotB, labD], 8.0, 0.5, 2)),
            by(rule("dijkstra-risk-path.pl", clause(19))),
            ...
            uses([
              proof(
                goal(route_segment(depotA, depotB, 4.0, 0.2)),
                by(rule("dijkstra-risk-path.pl", clause(12))),
                ...
                uses([
                  proof(
                    goal(route_network(riskNetwork, (segment(depotA, segment(depotB, 4.0, 0.2)), segment(depotB, segment(labD, 4.0, 0.3)), segment(depotA, segment(depotC, 3.0, 0.9)), segment(depotC, segment(labD, 6.0, 0.3)), segment(depotC, segment(depotB, 0.5, 0.5)), segment(depotB, segment(depotC, 1.0, 0.5)), segment(depotA, segment(relay, 5.0, 0.2)), segment(relay, segment(labD, 5.0, 0.2)), segment(depotA, segment(labD, 14.0, 0.05))))),
                    by(fact("dijkstra-risk-path.pl", clause(11)))
                  ),
                  proof(
                    goal(formula_binary((segment(depotA, segment(depotB, 4.0, 0.2)), segment(depotB, segment(labD, 4.0, 0.3)), segment(depotA, segment(depotC, 3.0, 0.9)), segment(depotC, segment(labD, 6.0, 0.3)), segment(depotC, segment(depotB, 0.5, 0.5)), segment(depotB, segment(depotC, 1.0, 0.5)), segment(depotA, segment(relay, 5.0, 0.2)), segment(relay, segment(labD, 5.0, 0.2)), segment(depotA, segment(labD, 14.0, 0.05))), depotA, segment, segment(depotB, 4.0, 0.2))),
                    by(builtin(formula_binary, 4))
                  )
                ])
              ),
              proof(
                goal(route_cost([depotB, labD], 4.0, 0.29999999999999999, 1)),
                by(rule("dijkstra-risk-path.pl", clause(19))),
                ...
                uses([
                  proof(
                    goal(route_segment(depotB, labD, 4.0, 0.3)),
                    by(rule("dijkstra-risk-path.pl", clause(12))),
                    ...
                    uses([
                      ...
                      proof(
                        goal(formula_binary((segment(depotA, segment(depotB, 4.0, 0.2)), segment(depotB, segment(labD, 4.0, 0.3)), segment(depotA, segment(depotC, 3.0, 0.9)), segment(depotC, segment(labD, 6.0, 0.3)), segment(depotC, segment(depotB, 0.5, 0.5)), segment(depotB, segment(depotC, 1.0, 0.5)), segment(depotA, segment(relay, 5.0, 0.2)), segment(relay, segment(labD, 5.0, 0.2)), segment(depotA, segment(labD, 14.0, 0.05))), depotB, segment, segment(labD, 4.0, 0.3))),
                        by(builtin(formula_binary, 4))
                      )
                    ])
                  ),
                  proof(
                    goal(route_cost([labD], 0.0, 0.0, 0)),
                    by(fact("dijkstra-risk-path.pl", clause(18))),
                    bindings([binding("__anon0", labD)])
                  ),
                  proof(
                    goal(add(4.0, 0.0, 4.0)),
                    by(builtin(add, 3))
                  ),
                  proof(
                    goal(add(0.3, 0.0, 0.29999999999999999)),
                    by(builtin(add, 3))
                  ),
                  proof(
                    goal(add(1, 0, 1)),
              ...
              proof(
                goal(add(4.0, 4.0, 8.0)),
                by(builtin(add, 3))
              ),
              proof(
                goal(add(0.2, 0.29999999999999999, 0.5)),
                by(builtin(add, 3))
              ),
              proof(
                goal(add(1, 1, 2)),
          ...
          proof(
            goal(score(8.0, 0.5, 13.0)),
            by(rule("dijkstra-risk-path.pl", clause(20))),
            bindings([binding("Raw", 8.0), binding("Risk", 0.5), binding("Score", 13.0), binding("Penalty", 5.0)]),
            uses([
              proof(
                goal(mul(0.5, 10.0, 5.0)),
                by(builtin(mul, 3))
              ),
              proof(
                goal(add(8.0, 5.0, 13.0)),
                by(builtin(add, 3))
              )
            ])
          )
...
why(
  route(pathC, [depotA, depotC, labD]),
  proof(
    goal(route(pathC, [depotA, depotC, labD])),
    by(rule("dijkstra-risk-path.pl", clause(24))),
    ...
    uses([
      proof(
        goal(path_metrics(pathC, [depotA, depotC, labD], 9.0, 1.2, 21.0, 2)),
        by(rule("dijkstra-risk-path.pl", clause(21))),
        ...
        uses([
          proof(
            goal(candidate(pathC, [depotA, depotC, labD])),
            by(fact("dijkstra-risk-path.pl", clause(14)))
          ),
          proof(
            goal(route_cost([depotA, depotC, labD], 9.0, 1.2, 2)),
            by(rule("dijkstra-risk-path.pl", clause(19))),
            ...
            uses([
              proof(
                goal(route_segment(depotA, depotC, 3.0, 0.9)),
                by(rule("dijkstra-risk-path.pl", clause(12))),
                ...
                uses([
                  ...
                  proof(
                    goal(formula_binary((segment(depotA, segment(depotB, 4.0, 0.2)), segment(depotB, segment(labD, 4.0, 0.3)), segment(depotA, segment(depotC, 3.0, 0.9)), segment(depotC, segment(labD, 6.0, 0.3)), segment(depotC, segment(depotB, 0.5, 0.5)), segment(depotB, segment(depotC, 1.0, 0.5)), segment(depotA, segment(relay, 5.0, 0.2)), segment(relay, segment(labD, 5.0, 0.2)), segment(depotA, segment(labD, 14.0, 0.05))), depotA, segment, segment(depotC, 3.0, 0.9))),
                    by(builtin(formula_binary, 4))
                  )
                ])
              ),
              proof(
                goal(route_cost([depotC, labD], 6.0, 0.29999999999999999, 1)),
                by(rule("dijkstra-risk-path.pl", clause(19))),
                ...
                uses([
                  proof(
                    goal(route_segment(depotC, labD, 6.0, 0.3)),
                    by(rule("dijkstra-risk-path.pl", clause(12))),
                    ...
                    uses([
                      ...
                      proof(
                        goal(formula_binary((segment(depotA, segment(depotB, 4.0, 0.2)), segment(depotB, segment(labD, 4.0, 0.3)), segment(depotA, segment(depotC, 3.0, 0.9)), segment(depotC, segment(labD, 6.0, 0.3)), segment(depotC, segment(depotB, 0.5, 0.5)), segment(depotB, segment(depotC, 1.0, 0.5)), segment(depotA, segment(relay, 5.0, 0.2)), segment(relay, segment(labD, 5.0, 0.2)), segment(depotA, segment(labD, 14.0, 0.05))), depotC, segment, segment(labD, 6.0, 0.3))),
                        by(builtin(formula_binary, 4))
                      )
                    ])
                  ),
              ...
              proof(
                goal(add(3.0, 6.0, 9.0)),
                by(builtin(add, 3))
              ),
              proof(
                goal(add(0.9, 0.29999999999999999, 1.2)),
                by(builtin(add, 3))
              ),
              proof(
                goal(add(1, 1, 2)),
...
why(
  route(pathRelay, [depotA, relay, labD]),
  proof(
    goal(route(pathRelay, [depotA, relay, labD])),
    by(rule("dijkstra-risk-path.pl", clause(24))),
    ...
    uses([
      proof(
        goal(path_metrics(pathRelay, [depotA, relay, labD], 10.0, 0.40000000000000002, 14.0, 2)),
        by(rule("dijkstra-risk-path.pl", clause(21))),
        ...
        uses([
          proof(
            goal(candidate(pathRelay, [depotA, relay, labD])),
            by(fact("dijkstra-risk-path.pl", clause(15)))
          ),
          proof(
            goal(route_cost([depotA, relay, labD], 10.0, 0.40000000000000002, 2)),
            by(rule("dijkstra-risk-path.pl", clause(19))),
            ...
            uses([
              proof(
                goal(route_segment(depotA, relay, 5.0, 0.2)),
                by(rule("dijkstra-risk-path.pl", clause(12))),
                ...
                uses([
                  ...
                  proof(
                    goal(formula_binary((segment(depotA, segment(depotB, 4.0, 0.2)), segment(depotB, segment(labD, 4.0, 0.3)), segment(depotA, segment(depotC, 3.0, 0.9)), segment(depotC, segment(labD, 6.0, 0.3)), segment(depotC, segment(depotB, 0.5, 0.5)), segment(depotB, segment(depotC, 1.0, 0.5)), segment(depotA, segment(relay, 5.0, 0.2)), segment(relay, segment(labD, 5.0, 0.2)), segment(depotA, segment(labD, 14.0, 0.05))), depotA, segment, segment(relay, 5.0, 0.2))),
                    by(builtin(formula_binary, 4))
                  )
                ])
              ),
              proof(
                goal(route_cost([relay, labD], 5.0, 0.20000000000000001, 1)),
                by(rule("dijkstra-risk-path.pl", clause(19))),
                ...
                uses([
                  proof(
                    goal(route_segment(relay, labD, 5.0, 0.2)),
                    by(rule("dijkstra-risk-path.pl", clause(12))),
                    ...
                    uses([
                      ...
                      proof(
                        goal(formula_binary((segment(depotA, segment(depotB, 4.0, 0.2)), segment(depotB, segment(labD, 4.0, 0.3)), segment(depotA, segment(depotC, 3.0, 0.9)), segment(depotC, segment(labD, 6.0, 0.3)), segment(depotC, segment(depotB, 0.5, 0.5)), segment(depotB, segment(depotC, 1.0, 0.5)), segment(depotA, segment(relay, 5.0, 0.2)), segment(relay, segment(labD, 5.0, 0.2)), segment(depotA, segment(labD, 14.0, 0.05))), relay, segment, segment(labD, 5.0, 0.2))),
                        by(builtin(formula_binary, 4))
                      )
                    ])
                  ),
                  ...
                  proof(
                    goal(add(5.0, 0.0, 5.0)),
                    by(builtin(add, 3))
                  ),
                  proof(
                    goal(add(0.2, 0.0, 0.20000000000000001)),
                    by(builtin(add, 3))
                  ),
                  proof(
                    goal(add(1, 0, 1)),
              ...
              proof(
                goal(add(5.0, 5.0, 10.0)),
                by(builtin(add, 3))
              ),
              proof(
                goal(add(0.2, 0.20000000000000001, 0.40000000000000002)),
                by(builtin(add, 3))
              ),
              proof(
                goal(add(1, 1, 2)),
          ...
          proof(
            goal(score(10.0, 0.40000000000000002, 14.0)),
            by(rule("dijkstra-risk-path.pl", clause(20))),
...
why(
  route(pathDirectC, [depotA, labD]),
  proof(
    goal(route(pathDirectC, [depotA, labD])),
    by(rule("dijkstra-risk-path.pl", clause(24))),
    ...
    uses([
      proof(
        goal(path_metrics(pathDirectC, [depotA, labD], 14.0, 0.050000000000000003, 14.5, 1)),
        by(rule("dijkstra-risk-path.pl", clause(21))),
        ...
        uses([
          proof(
            goal(candidate(pathDirectC, [depotA, labD])),
            by(fact("dijkstra-risk-path.pl", clause(16)))
          ),
          proof(
            goal(route_cost([depotA, labD], 14.0, 0.050000000000000003, 1)),
            by(rule("dijkstra-risk-path.pl", clause(19))),
            ...
            uses([
              proof(
                goal(route_segment(depotA, labD, 14.0, 0.05)),
                by(rule("dijkstra-risk-path.pl", clause(12))),
                ...
                uses([
                  ...
                  proof(
                    goal(formula_binary((segment(depotA, segment(depotB, 4.0, 0.2)), segment(depotB, segment(labD, 4.0, 0.3)), segment(depotA, segment(depotC, 3.0, 0.9)), segment(depotC, segment(labD, 6.0, 0.3)), segment(depotC, segment(depotB, 0.5, 0.5)), segment(depotB, segment(depotC, 1.0, 0.5)), segment(depotA, segment(relay, 5.0, 0.2)), segment(relay, segment(labD, 5.0, 0.2)), segment(depotA, segment(labD, 14.0, 0.05))), depotA, segment, segment(labD, 14.0, 0.05))),
                    by(builtin(formula_binary, 4))
                  )
                ])
              ),
              ...
              proof(
                goal(add(14.0, 0.0, 14.0)),
                by(builtin(add, 3))
              ),
              proof(
                goal(add(0.05, 0.0, 0.050000000000000003)),
                by(builtin(add, 3))
              ),
              proof(
                goal(add(1, 0, 1)),
          ...
          proof(
            goal(score(14.0, 0.050000000000000003, 14.5)),
            by(rule("dijkstra-risk-path.pl", clause(20))),
            bindings([binding("Raw", 14.0), binding("Risk", 0.050000000000000003), binding("Score", 14.5), binding("Penalty", 0.5)]),
            uses([
              proof(
                goal(mul(0.050000000000000003, 10.0, 0.5)),
                by(builtin(mul, 3))
              ),
              proof(
                goal(add(14.0, 0.5, 14.5)),
                by(builtin(add, 3))
              )
            ])
          )
...
why(
  route(pathViaC, [depotA, depotC, depotB, labD]),
  proof(
    goal(route(pathViaC, [depotA, depotC, depotB, labD])),
    by(rule("dijkstra-risk-path.pl", clause(24))),
    ...
    uses([
      proof(
        goal(path_metrics(pathViaC, [depotA, depotC, depotB, labD], 7.5, 1.7000000000000002, 24.5, 3)),
        by(rule("dijkstra-risk-path.pl", clause(21))),
        ...
        uses([
          proof(
            goal(candidate(pathViaC, [depotA, depotC, depotB, labD])),
            by(fact("dijkstra-risk-path.pl", clause(17)))
          ),
          proof(
            goal(route_cost([depotA, depotC, depotB, labD], 7.5, 1.7000000000000002, 3)),
            by(rule("dijkstra-risk-path.pl", clause(19))),
            ...
            uses([
              ...
              proof(
                goal(route_cost([depotC, depotB, labD], 4.5, 0.80000000000000004, 2)),
                by(rule("dijkstra-risk-path.pl", clause(19))),
                ...
                uses([
                  proof(
                    goal(route_segment(depotC, depotB, 0.5, 0.5)),
                    by(rule("dijkstra-risk-path.pl", clause(12))),
                    ...
                    uses([
                      ...
                      proof(
                        goal(formula_binary((segment(depotA, segment(depotB, 4.0, 0.2)), segment(depotB, segment(labD, 4.0, 0.3)), segment(depotA, segment(depotC, 3.0, 0.9)), segment(depotC, segment(labD, 6.0, 0.3)), segment(depotC, segment(depotB, 0.5, 0.5)), segment(depotB, segment(depotC, 1.0, 0.5)), segment(depotA, segment(relay, 5.0, 0.2)), segment(relay, segment(labD, 5.0, 0.2)), segment(depotA, segment(labD, 14.0, 0.05))), depotC, segment, segment(depotB, 0.5, 0.5))),
                        by(builtin(formula_binary, 4))
                      )
                    ])
                  ),
                  ...
                  proof(
                    goal(add(0.5, 4.0, 4.5)),
                    by(builtin(add, 3))
                  ),
                  proof(
                    goal(add(0.5, 0.29999999999999999, 0.80000000000000004)),
                    by(builtin(add, 3))
                  ),
                  proof(
                    goal(add(1, 1, 2)),
              ...
              proof(
                goal(add(3.0, 4.5, 7.5)),
                by(builtin(add, 3))
              ),
              proof(
                goal(add(0.9, 0.80000000000000004, 1.7000000000000002)),
                by(builtin(add, 3))
              ),
              proof(
                goal(add(1, 2, 3)),
          ...
          proof(
            goal(score(7.5, 1.7000000000000002, 24.5)),
            by(rule("dijkstra-risk-path.pl", clause(20))),
            bindings([binding("Raw", 7.5), binding("Risk", 1.7000000000000002), binding("Score", 24.5), binding("Penalty", 17.0)]),
            uses([
              proof(
                goal(mul(1.7000000000000002, 10.0, 17.0)),
                by(builtin(mul, 3))
              ),
              proof(
                goal(add(7.5, 17.0, 24.5)),
                by(builtin(add, 3))
              )
            ])
          )
...
why(
  rawCost(pathB, 8.0),
  proof(
    goal(rawCost(pathB, 8.0)),
    by(rule("dijkstra-risk-path.pl", clause(25))),
...
why(
  riskSum(pathB, 0.5),
  proof(
    goal(riskSum(pathB, 0.5)),
    by(rule("dijkstra-risk-path.pl", clause(26))),
...
why(
  riskSum(pathRelay, 0.40000000000000002),
  proof(
    goal(riskSum(pathRelay, 0.40000000000000002)),
    by(rule("dijkstra-risk-path.pl", clause(26))),
...
why(
  riskSum(pathDirectC, 0.050000000000000003),
  proof(
    goal(riskSum(pathDirectC, 0.050000000000000003)),
    by(rule("dijkstra-risk-path.pl", clause(26))),
...
why(
  riskSum(pathViaC, 1.7000000000000002),
  proof(
    goal(riskSum(pathViaC, 1.7000000000000002)),
    by(rule("dijkstra-risk-path.pl", clause(26))),
...
why(
  score(pathB, 13.0),
  proof(
    goal(score(pathB, 13.0)),
    by(rule("dijkstra-risk-path.pl", clause(27))),
...
why(
  edgeCount(pathB, 2),
  proof(
    goal(edgeCount(pathB, 2)),
    by(rule("dijkstra-risk-path.pl", clause(28))),
...
why(
  selectedPath(case, pathB),
  proof(
    goal(selectedPath(case, pathB)),
    by(rule("dijkstra-risk-path.pl", clause(29))),
    bindings([binding("Path", pathB)]),
    uses([
      proof(
        goal(best_path(pathB)),
        by(rule("dijkstra-risk-path.pl", clause(22))),
...
why(
  trustGate(case, noEnumeratedPathIsLower),
  proof(
    goal(trustGate(case, noEnumeratedPathIsLower)),
    by(rule("dijkstra-risk-path.pl", clause(30))),
...
why(
  notes(case, riskCanOutweighRawCost),
  proof(
    goal(notes(case, riskCanOutweighRawCost)),
    by(rule("dijkstra-risk-path.pl", clause(31))),
    uses([
      proof(
        goal(risk_outweighs_raw_cost(true)),
        by(rule("dijkstra-risk-path.pl", clause(23))),
...
why(
  selects(dijkstraRiskPath, pathB),
  proof(
    goal(selects(dijkstraRiskPath, pathB)),
    by(rule("dijkstra-risk-path.pl", clause(32))),
    bindings([binding("Path", pathB)]),
    uses([
      proof(
        goal(best_path(pathB)),
