...
why(
  easterDate(y2026, date(2026, april, 5)),
  proof(
    goal(easterDate(y2026, date(2026, april, 5))),
    by(rule("easter-computus.pl", clause(23))),
    ...
    uses([
      proof(
        goal(computus(y2026, 2026, 4, 5, 12, 20, 6, 12, 2, 4)),
        by(rule("easter-computus.pl", clause(21))),
        ...
        uses([
          proof(
            goal(case(y2026, 2026)),
            by(fact("easter-computus.pl", clause(4)))
          ),
          proof(
            goal(mod(2026, 19, 12)),
            by(builtin(mod, 3))
          ...
          proof(
            goal(div(2026, 100, 20)),
            by(builtin(div, 3))
          ),
          proof(
            goal(mod(2026, 100, 26)),
            by(builtin(mod, 3))
          ),
          proof(
            goal(div(20, 4, 5)),
      ...
      proof(
        goal(month_name(4, april)),
        by(fact("easter-computus.pl", clause(20)))
      )
    ])
  )
).
...
why(
  easterDate(y2027, date(2027, march, 28)),
  proof(
    goal(easterDate(y2027, date(2027, march, 28))),
    by(rule("easter-computus.pl", clause(23))),
    ...
    uses([
      proof(
        goal(computus(y2027, 2027, 3, 28, 13, 20, 6, 1, 5, 27)),
        by(rule("easter-computus.pl", clause(21))),
        ...
        uses([
          proof(
            goal(case(y2027, 2027)),
            by(fact("easter-computus.pl", clause(5)))
          ),
          proof(
            goal(mod(2027, 19, 13)),
            by(builtin(mod, 3))
          ...
          proof(
            goal(div(2027, 100, 20)),
            by(builtin(div, 3))
          ),
          proof(
            goal(mod(2027, 100, 27)),
            by(builtin(mod, 3))
          ),
          proof(
            goal(div(20, 4, 5)),
      ...
      proof(
        goal(month_name(3, march)),
        by(fact("easter-computus.pl", clause(19)))
      )
    ])
  )
).
...
why(
  easterDate(y2028, date(2028, april, 16)),
  proof(
    goal(easterDate(y2028, date(2028, april, 16))),
    by(rule("easter-computus.pl", clause(23))),
    ...
    uses([
      proof(
        goal(computus(y2028, 2028, 4, 16, 14, 20, 6, 20, 5, 15)),
        by(rule("easter-computus.pl", clause(21))),
        ...
        uses([
          proof(
            goal(case(y2028, 2028)),
            by(fact("easter-computus.pl", clause(6)))
          ),
          proof(
            goal(mod(2028, 19, 14)),
            by(builtin(mod, 3))
          ...
          proof(
            goal(div(2028, 100, 20)),
            by(builtin(div, 3))
          ),
          proof(
            goal(mod(2028, 100, 28)),
            by(builtin(mod, 3))
          ),
          proof(
            goal(div(20, 4, 5)),
...
why(
  easterDate(y2029, date(2029, april, 1)),
  proof(
    goal(easterDate(y2029, date(2029, april, 1))),
    by(rule("easter-computus.pl", clause(23))),
    ...
    uses([
      proof(
        goal(computus(y2029, 2029, 4, 1, 15, 20, 6, 9, 1, 0)),
        by(rule("easter-computus.pl", clause(21))),
        ...
        uses([
          proof(
            goal(case(y2029, 2029)),
            by(fact("easter-computus.pl", clause(7)))
          ),
          proof(
            goal(mod(2029, 19, 15)),
            by(builtin(mod, 3))
          ...
          proof(
            goal(div(2029, 100, 20)),
            by(builtin(div, 3))
          ),
          proof(
            goal(mod(2029, 100, 29)),
            by(builtin(mod, 3))
          ),
          proof(
            goal(div(20, 4, 5)),
...
why(
  easterDate(y2030, date(2030, april, 21)),
  proof(
    goal(easterDate(y2030, date(2030, april, 21))),
    by(rule("easter-computus.pl", clause(23))),
    ...
    uses([
      proof(
        goal(computus(y2030, 2030, 4, 21, 16, 20, 6, 28, 2, 20)),
        by(rule("easter-computus.pl", clause(21))),
        ...
        uses([
          proof(
            goal(case(y2030, 2030)),
            by(fact("easter-computus.pl", clause(8)))
          ),
          proof(
            goal(mod(2030, 19, 16)),
            by(builtin(mod, 3))
          ...
          proof(
            goal(div(2030, 100, 20)),
            by(builtin(div, 3))
          ),
          proof(
            goal(mod(2030, 100, 30)),
            by(builtin(mod, 3))
          ),
          proof(
            goal(div(20, 4, 5)),
...
why(
  easterDate(y2031, date(2031, april, 13)),
  proof(
    goal(easterDate(y2031, date(2031, april, 13))),
    by(rule("easter-computus.pl", clause(23))),
    ...
    uses([
      proof(
        goal(computus(y2031, 2031, 4, 13, 17, 20, 6, 17, 5, 12)),
        by(rule("easter-computus.pl", clause(21))),
        ...
        uses([
          proof(
            goal(case(y2031, 2031)),
            by(fact("easter-computus.pl", clause(9)))
          ),
          proof(
            goal(mod(2031, 19, 17)),
            by(builtin(mod, 3))
          ...
          proof(
            goal(div(2031, 100, 20)),
            by(builtin(div, 3))
          ),
          proof(
            goal(mod(2031, 100, 31)),
            by(builtin(mod, 3))
          ),
          proof(
            goal(div(20, 4, 5)),
...
why(
  easterDate(y2032, date(2032, march, 28)),
  proof(
    goal(easterDate(y2032, date(2032, march, 28))),
    by(rule("easter-computus.pl", clause(23))),
    ...
    uses([
      proof(
        goal(computus(y2032, 2032, 3, 28, 18, 20, 6, 6, 0, 27)),
        by(rule("easter-computus.pl", clause(21))),
        ...
        uses([
          proof(
            goal(case(y2032, 2032)),
            by(fact("easter-computus.pl", clause(10)))
          ),
          proof(
            goal(mod(2032, 19, 18)),
            by(builtin(mod, 3))
          ...
          proof(
            goal(div(2032, 100, 20)),
            by(builtin(div, 3))
          ),
          proof(
            goal(mod(2032, 100, 32)),
            by(builtin(mod, 3))
          ),
          proof(
            goal(div(20, 4, 5)),
...
why(
  easterDate(y2033, date(2033, april, 17)),
  proof(
    goal(easterDate(y2033, date(2033, april, 17))),
    by(rule("easter-computus.pl", clause(23))),
    ...
    uses([
      proof(
        goal(computus(y2033, 2033, 4, 17, 0, 20, 6, 24, 2, 16)),
        by(rule("easter-computus.pl", clause(21))),
        ...
        uses([
          proof(
            goal(case(y2033, 2033)),
            by(fact("easter-computus.pl", clause(11)))
          ),
          proof(
            goal(mod(2033, 19, 0)),
            by(builtin(mod, 3))
          ...
          proof(
            goal(div(2033, 100, 20)),
            by(builtin(div, 3))
          ),
          proof(
            goal(mod(2033, 100, 33)),
            by(builtin(mod, 3))
          ),
          proof(
            goal(div(20, 4, 5)),
...
why(
  easterDate(y2034, date(2034, april, 9)),
  proof(
    goal(easterDate(y2034, date(2034, april, 9))),
    by(rule("easter-computus.pl", clause(23))),
    ...
    uses([
      proof(
        goal(computus(y2034, 2034, 4, 9, 1, 20, 6, 13, 5, 8)),
        by(rule("easter-computus.pl", clause(21))),
        ...
        uses([
          proof(
            goal(case(y2034, 2034)),
            by(fact("easter-computus.pl", clause(12)))
          ),
          proof(
            goal(mod(2034, 19, 1)),
            by(builtin(mod, 3))
          ...
          proof(
            goal(div(2034, 100, 20)),
            by(builtin(div, 3))
          ),
          proof(
            goal(mod(2034, 100, 34)),
            by(builtin(mod, 3))
          ),
          proof(
            goal(div(20, 4, 5)),
...
why(
  easterDate(y2035, date(2035, march, 25)),
  proof(
    goal(easterDate(y2035, date(2035, march, 25))),
    by(rule("easter-computus.pl", clause(23))),
    ...
    uses([
      proof(
        goal(computus(y2035, 2035, 3, 25, 2, 20, 6, 2, 1, 24)),
        by(rule("easter-computus.pl", clause(21))),
        ...
        uses([
          proof(
            goal(case(y2035, 2035)),
            by(fact("easter-computus.pl", clause(13)))
          ),
          proof(
            goal(mod(2035, 19, 2)),
            by(builtin(mod, 3))
          ...
          proof(
            goal(div(2035, 100, 20)),
            by(builtin(div, 3))
          ),
          proof(
            goal(mod(2035, 100, 35)),
            by(builtin(mod, 3))
          ),
          proof(
            goal(div(20, 4, 5)),
...
why(
  computusRemainders(y2026, remainders(12, 12, 2)),
  proof(
    goal(computusRemainders(y2026, remainders(12, 12, 2))),
    by(rule("easter-computus.pl", clause(24))),
...
why(
  computusRemainders(y2027, remainders(13, 1, 5)),
  proof(
    goal(computusRemainders(y2027, remainders(13, 1, 5))),
    by(rule("easter-computus.pl", clause(24))),
...
why(
  computusRemainders(y2028, remainders(14, 20, 5)),
  proof(
    goal(computusRemainders(y2028, remainders(14, 20, 5))),
    by(rule("easter-computus.pl", clause(24))),
...
why(
  computusRemainders(y2029, remainders(15, 9, 1)),
  proof(
    goal(computusRemainders(y2029, remainders(15, 9, 1))),
    by(rule("easter-computus.pl", clause(24))),
...
why(
  computusRemainders(y2030, remainders(16, 28, 2)),
  proof(
    goal(computusRemainders(y2030, remainders(16, 28, 2))),
    by(rule("easter-computus.pl", clause(24))),
...
why(
  computusRemainders(y2031, remainders(17, 17, 5)),
  proof(
    goal(computusRemainders(y2031, remainders(17, 17, 5))),
    by(rule("easter-computus.pl", clause(24))),
...
why(
  computusRemainders(y2032, remainders(18, 6, 0)),
  proof(
    goal(computusRemainders(y2032, remainders(18, 6, 0))),
    by(rule("easter-computus.pl", clause(24))),
...
why(
  computusRemainders(y2033, remainders(0, 24, 2)),
  proof(
    goal(computusRemainders(y2033, remainders(0, 24, 2))),
    by(rule("easter-computus.pl", clause(24))),
...
why(
  computusRemainders(y2034, remainders(1, 13, 5)),
  proof(
    goal(computusRemainders(y2034, remainders(1, 13, 5))),
    by(rule("easter-computus.pl", clause(24))),
...
why(
  computusRemainders(y2035, remainders(2, 2, 1)),
  proof(
    goal(computusRemainders(y2035, remainders(2, 2, 1))),
    by(rule("easter-computus.pl", clause(24))),
...
why(
  legalGregorianWindow(y2026, true),
  proof(
    goal(legalGregorianWindow(y2026, true)),
    by(rule("easter-computus.pl", clause(25))),
    bindings([binding("Case", y2026)]),
    uses([
      proof(
        goal(checks_pass(y2026)),
        by(rule("easter-computus.pl", clause(22))),
        ...
        uses([
          ...
          proof(
            goal(valid_golden(12)),
            by(rule("easter-computus.pl", clause(14))),
            bindings([binding("N", 12)]),
            uses([
              proof(
                goal(between(0, 18, 12)),
          ...
          proof(
            goal(valid_epact(12)),
            by(rule("easter-computus.pl", clause(15))),
            bindings([binding("N", 12)]),
            uses([
              proof(
                goal(between(0, 29, 12)),
                by(builtin(between, 3))
              )
            ])
          ),
          proof(
            goal(valid_weekday(2)),
            by(rule("easter-computus.pl", clause(16))),
          ...
          proof(
            goal(legal_easter_date(4, 5)),
            by(rule("easter-computus.pl", clause(18))),
...
why(
  legalGregorianWindow(y2027, true),
  proof(
    goal(legalGregorianWindow(y2027, true)),
    by(rule("easter-computus.pl", clause(25))),
    bindings([binding("Case", y2027)]),
    uses([
      proof(
        goal(checks_pass(y2027)),
        by(rule("easter-computus.pl", clause(22))),
        ...
        uses([
          ...
          proof(
            goal(valid_golden(13)),
            by(rule("easter-computus.pl", clause(14))),
            bindings([binding("N", 13)]),
            uses([
              proof(
                goal(between(0, 18, 13)),
                by(builtin(between, 3))
              )
            ])
          ),
          ...
          proof(
            goal(legal_easter_date(3, 28)),
            by(rule("easter-computus.pl", clause(17))),
            bindings([binding("D", 28)]),
            uses([
              proof(
                goal(between(22, 31, 28)),
                by(builtin(between, 3))
              )
            ])
          )
...
why(
  legalGregorianWindow(y2028, true),
  proof(
    goal(legalGregorianWindow(y2028, true)),
    by(rule("easter-computus.pl", clause(25))),
    bindings([binding("Case", y2028)]),
    uses([
      proof(
        goal(checks_pass(y2028)),
        by(rule("easter-computus.pl", clause(22))),
        ...
        uses([
          ...
          proof(
            goal(valid_golden(14)),
            by(rule("easter-computus.pl", clause(14))),
            bindings([binding("N", 14)]),
            uses([
              proof(
                goal(between(0, 18, 14)),
                by(builtin(between, 3))
              )
            ])
          ),
          ...
          proof(
            goal(legal_easter_date(4, 16)),
            by(rule("easter-computus.pl", clause(18))),
            bindings([binding("D", 16)]),
            uses([
              proof(
                goal(between(1, 25, 16)),
                by(builtin(between, 3))
              )
            ])
          )
...
why(
  legalGregorianWindow(y2029, true),
  proof(
    goal(legalGregorianWindow(y2029, true)),
    by(rule("easter-computus.pl", clause(25))),
    bindings([binding("Case", y2029)]),
    uses([
      proof(
        goal(checks_pass(y2029)),
        by(rule("easter-computus.pl", clause(22))),
        ...
        uses([
          ...
          proof(
            goal(valid_golden(15)),
            by(rule("easter-computus.pl", clause(14))),
            bindings([binding("N", 15)]),
            uses([
              proof(
                goal(between(0, 18, 15)),
                by(builtin(between, 3))
              )
            ])
          ),
...
why(
  legalGregorianWindow(y2030, true),
  proof(
    goal(legalGregorianWindow(y2030, true)),
    by(rule("easter-computus.pl", clause(25))),
    bindings([binding("Case", y2030)]),
    uses([
      proof(
        goal(checks_pass(y2030)),
        by(rule("easter-computus.pl", clause(22))),
        ...
        uses([
          ...
          proof(
            goal(valid_golden(16)),
            by(rule("easter-computus.pl", clause(14))),
            bindings([binding("N", 16)]),
            uses([
              proof(
                goal(between(0, 18, 16)),
                by(builtin(between, 3))
              )
            ])
          ),
          ...
          proof(
            goal(legal_easter_date(4, 21)),
            by(rule("easter-computus.pl", clause(18))),
            bindings([binding("D", 21)]),
            uses([
              proof(
                goal(between(1, 25, 21)),
                by(builtin(between, 3))
              )
            ])
          )
...
why(
  legalGregorianWindow(y2031, true),
  proof(
    goal(legalGregorianWindow(y2031, true)),
    by(rule("easter-computus.pl", clause(25))),
    bindings([binding("Case", y2031)]),
    uses([
      proof(
        goal(checks_pass(y2031)),
        by(rule("easter-computus.pl", clause(22))),
        ...
        uses([
          ...
          proof(
            goal(valid_golden(17)),
            by(rule("easter-computus.pl", clause(14))),
            bindings([binding("N", 17)]),
            uses([
              proof(
                goal(between(0, 18, 17)),
                by(builtin(between, 3))
              )
            ])
          ),
          ...
          proof(
            goal(legal_easter_date(4, 13)),
            by(rule("easter-computus.pl", clause(18))),
            bindings([binding("D", 13)]),
            uses([
              proof(
                goal(between(1, 25, 13)),
                by(builtin(between, 3))
              )
            ])
          )
...
why(
  legalGregorianWindow(y2032, true),
  proof(
    goal(legalGregorianWindow(y2032, true)),
    by(rule("easter-computus.pl", clause(25))),
    bindings([binding("Case", y2032)]),
    uses([
      proof(
        goal(checks_pass(y2032)),
        by(rule("easter-computus.pl", clause(22))),
        ...
        uses([
          ...
          proof(
            goal(valid_golden(18)),
            by(rule("easter-computus.pl", clause(14))),
            bindings([binding("N", 18)]),
            uses([
              proof(
                goal(between(0, 18, 18)),
                by(builtin(between, 3))
              )
            ])
          ),
...
why(
  legalGregorianWindow(y2033, true),
  proof(
    goal(legalGregorianWindow(y2033, true)),
    by(rule("easter-computus.pl", clause(25))),
    bindings([binding("Case", y2033)]),
    uses([
      proof(
        goal(checks_pass(y2033)),
        by(rule("easter-computus.pl", clause(22))),
        ...
        uses([
          ...
          proof(
            goal(legal_easter_date(4, 17)),
            by(rule("easter-computus.pl", clause(18))),
            bindings([binding("D", 17)]),
            uses([
              proof(
                goal(between(1, 25, 17)),
                by(builtin(between, 3))
              )
            ])
          )
...
why(
  legalGregorianWindow(y2034, true),
  proof(
    goal(legalGregorianWindow(y2034, true)),
    by(rule("easter-computus.pl", clause(25))),
    bindings([binding("Case", y2034)]),
    uses([
      proof(
        goal(checks_pass(y2034)),
        by(rule("easter-computus.pl", clause(22))),
...
why(
  legalGregorianWindow(y2035, true),
  proof(
    goal(legalGregorianWindow(y2035, true)),
    by(rule("easter-computus.pl", clause(25))),
    bindings([binding("Case", y2035)]),
    uses([
      proof(
        goal(checks_pass(y2035)),
        by(rule("easter-computus.pl", clause(22))),
        ...
        uses([
          ...
          proof(
            goal(legal_easter_date(3, 25)),
            by(rule("easter-computus.pl", clause(17))),
            bindings([binding("D", 25)]),
            uses([
              proof(
                goal(between(22, 31, 25)),
                by(builtin(between, 3))
              )
            ])
          )
