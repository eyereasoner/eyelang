...
why(
  ...
  proof(
    goal(path(a, b)),
    by(rule("cyclic-path.pl", clause(6))),
    bindings([binding("X", a), binding("Y", b)]),
    uses([
      proof(
        goal(arc(a, b)),
        by(fact("cyclic-path.pl", clause(2)))
      )
    ])
  )
).
...
why(
  ...
  proof(
    ...
    uses([
      proof(
        goal(arc(b, c)),
        by(fact("cyclic-path.pl", clause(3)))
      )
    ])
  )
).
...
why(
  ...
  proof(
    ...
    uses([
      proof(
        goal(arc(c, d)),
        by(fact("cyclic-path.pl", clause(4)))
      )
    ])
  )
).
...
why(
  ...
  proof(
    ...
    uses([
      proof(
        goal(arc(d, a)),
        by(fact("cyclic-path.pl", clause(5)))
      )
    ])
  )
).
...
why(
  ...
  proof(
    goal(path(a, c)),
    by(rule("cyclic-path.pl", clause(7))),
